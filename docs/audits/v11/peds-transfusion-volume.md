# v11 audit - peds-transfusion-volume

- Auditor: CG
- Date: 2026-06-06 (spec-v61).
- Citation re-verified against: New 2016 (Br J Haematol 2016;175:784-828).

lib/clinical-v7.js pedsTransfusionVolume() — volume = desired Hb rise x weight x 3 / product-Hct fraction; 10-15 mL/kg reference band.

## Boundary examples added
- See test/unit/peds-transfusion-volume.test.js (>=3 boundary cases, including the zero-denominator/null fallback and the impossible-input RangeError).

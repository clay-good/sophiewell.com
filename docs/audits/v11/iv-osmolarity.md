# v11 audit - iv-osmolarity

- Auditor: CG
- Date: 2026-06-06 (spec-v61).
- Citation re-verified against: Boullata 2014 ASPEN Safe Practices (JPEN 2014;38:334-377).

lib/clinical-v7.js ivOsmolarity() — osmolarity = dextrose%x50 + AA%x100 + (Na+K)x2 mOsm/L; ~900 mOsm/L central-line threshold.

## Boundary examples added
- See test/unit/iv-osmolarity.test.js (>=3 boundary cases, including the zero-denominator/null fallback and the impossible-input RangeError).

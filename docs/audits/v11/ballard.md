...
- Citation re-verified against: Ballard 1991 (New Ballard Score, J Pediatr 119:417).

lib/scoring-v6.js ballard() — maturity score -> GA = 24 + 0.4 x score, clamped to [20,44] weeks; +/-2 wk precision noted.

## Boundary examples added
- See test/unit/ballard.test.js (>=3 boundary cases, including band/age-band edges).

...
### Revised McGeer surveillance definitions (long-term-care infection)
Citation: Stone ND, Ashraf MS, Calder J, et al. Surveillance definitions of infections in long-term care facilities: revisiting the McGeer criteria. Infect Control Hosp Epidemiol. 2012. (Cross-verified against the primary paper and the Missouri DHSS / Minnesota DOH field tools, spec-v97.)
Formula: A categorical, site-branched surveillance case definition. The reviewer selects the suspected infection site and marks the constitutional and site-specific findings present; the tool returns whether the findings meet or do not meet the Revised McGeer surveillance definition for that site, naming the satisfied criteria and the blocking gap. It is a counting definition for infection tracking and reporting, not a diagnosis and not a treatment trigger.
Worked example: Suspected urinary tract infection without an indwelling catheter, with acute dysuria and a positive voided urine culture, meets the surveillance definition; the same clinical finding without a positive culture does not.

### Loeb minimum criteria (initiating antibiotics in long-term care)
...
### Lee Four-Year Mortality Index for Older Adults
Citation: Lee SJ, Lindquist K, Segal MR, Covinsky KE. Development and validation of a prognostic index for 4-year mortality in older adults. JAMA. 2006;295(7):801-808.
Formula: a weighted point sum from zero to twenty-six for community-dwelling older adults -- an age band (sixty to sixty-four scores one, rising to seven at eighty-five or older), male sex (two), diabetes (one), cancer (two), chronic lung disease (two), heart failure (two), current smoking (two), body-mass index below twenty-five (one), and difficulty with bathing (two), walking several blocks (two), managing money (two), and pushing or pulling heavy objects (one). The total maps to the validation-cohort four-year all-cause mortality bands: zero to five about four per cent, six to nine about fifteen per cent, ten to thirteen about forty-two per cent, and fourteen or more about sixty-four per cent. Weights and bands cross-verified against two or more sources (the JAMA tables, the abstract or MDCalc reproduction, and the SoFOG reference), spec-v97.
Worked example: a seventy-to-seventy-four-year-old (three) with heart failure (two) and a body-mass index below twenty-five (one) totals six, the lower edge of the fifteen-per-cent band. A prognostic estimate for care planning, not a prediction of an individual's death.

### interRAI CHESS Scale (Changes in Health, End-stage disease, Signs and Symptoms)
...
Citation: Johnson AEW, Kramer AA, Clifford GD. A new severity of illness scale using a subset of Acute Physiology and Chronic Health Evaluation data elements shows comparable predictive accuracy. Crit Care Med. 2013;41(7):1711-1718. (Grid cross-verified across two independent reference implementations; mortality logistic single-open-source, literature-corroborated, spec-v97.)
Formula: Ten banded variables — pre-ICU stay, age, Glasgow Coma Scale, heart rate, mean arterial pressure, respiratory rate, temperature, urine output, mechanical ventilation, and elective versus non-elective status — sum to a total from zero to seventy-five, which drives predicted in-hospital mortality through the logistic intercept minus 6.1746 plus 0.1275 times the total.
Worked example: A ventilated non-elective patient with a depressed Glasgow score, tachycardia, low mean pressure, tachypnea, hypothermia, and oliguria sums to fifty-one, a predicted in-hospital mortality near fifty-eight percent. A low-input alternative to APACHE II, a model estimate rather than an individual prognosis.

### LODS (Logistic Organ Dysfunction System)
Citation: Le Gall JR, Klar J, Lemeshow S, et al. The Logistic Organ Dysfunction system. A new way to assess organ dysfunction in the intensive care unit. JAMA. 1996;276(10):802-810. (Grid cross-verified across two open reproductions; mortality logistic single-open-source, sanity-checked, spec-v97.)
Formula: Six organ systems — neurologic, cardiovascular, renal, pulmonary, hematologic, and hepatic — each scored zero, one, three, or five by their worst first-day value, summing to a total from zero to twenty-two, which drives predicted hospital mortality through the logistic intercept minus 3.4043 plus 0.4173 times the total.
Worked example: A single-point neurologic deficit with a three-point renal derangement scores four, a predicted hospital mortality near fifteen percent. A calibrated organ-dysfunction complement to the sequential organ failure assessment, a model estimate rather than an order.

### Delta gap / delta ratio (mixed acid-base disorders)
Citation: Wrenn K. The delta (delta) gap: an approach to mixed acid-base disorders. Ann Emerg Med. 1990;19(11):1310-1313; corroborated by Rastegar A. J Am Soc Nephrol. 2007;18(9):2429-2431. (Cross-verified across two or more sources, spec-v97.)
Formula: The delta ratio is the rise in the anion gap above its normal value divided by the fall in bicarbonate below its normal value, with an optional albumin correction of the anion gap. Below four-tenths a concurrent non-anion-gap acidosis; four-tenths to under eight-tenths mixed; eight-tenths to under one borderline; one to two a pure high-anion-gap acidosis; above two a coexisting metabolic alkalosis or chronic respiratory acidosis.
Worked example: Sodium one-forty, chloride one-hundred, bicarbonate ten gives an anion gap of thirty and a delta ratio of about one and three-tenths, a pure high-anion-gap metabolic acidosis. Decision support, not an order.

### APPS score (Age, PaO2/FiO2, Plateau pressure in ARDS)
Citation: Villar J, Ambrós A, Soler JA, et al. Age, PaO2/FiO2, and Plateau Pressure Score: A Proposal for a Simple Outcome Score in Patients With the Acute Respiratory Distress Syndrome. Crit Care Med. 2016;44(7):1361-1369. (Cross-verified across two or more sources, spec-v97.)
Formula: Age under forty-seven, forty-seven to sixty-six, or over sixty-six adds one, two, or three; the oxygenation ratio over one-hundred-fifty-eight, one-hundred-five to one-hundred-fifty-eight, or under one-hundred-five adds one, two, or three; plateau pressure at or under twenty-seven, over twenty-seven to thirty, or over thirty adds one, two, or three. The total from three to nine stratifies mortality: low three to four, intermediate five to seven, high eight to nine.
Worked example: An older patient with severe hypoxemia and a high plateau pressure scores nine, the high-mortality tier. A simple outcome stratifier, not a ventilator order.

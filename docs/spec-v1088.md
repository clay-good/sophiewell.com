...
|---|---|---|
| **A region with no disease in it** — `pasi`, `easi`, `vasi`, `lund-browder`, `scorad`, `mswat` | 13 | 0% body surface involved is a real finding, and each of these prints the regions it summed. Likely correct as they stand. |

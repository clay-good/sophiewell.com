...
combobox over all 1,775 utilities, and nothing else. Each utility runs entirely
...
| G | Clinical Scoring & Risk | 1367 |
| H | Workflow & Documentation | 28 |
| I | EMS & Field Medicine | 21 |
| J | Immunization & Infectious Disease | 11 |
| K | Reference Ranges | 0 |
| L | Insurance Glossary | 0 |
| M | State & Coverage Reference | 38 |

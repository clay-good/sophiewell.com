...
- **A ledger exempts a TILE, and the judgment behind it is per FIELD.** spec-v1029 found five scores
  ...
  asked per field by construction. It found 81 field/tile pairs that move their answer; twenty-six calculators are
  fixed across spec-v1063 to spec-v1065. Until the rest of that list is classified there is no gate — a ledger

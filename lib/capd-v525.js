...
export const CAPD_ITEMS = [
  { key: 'q1', text: 'Does the child make eye contact with the caregiver?', reversed: true, options: PRESERVED },
  { key: 'q2', text: 'Are the child’s actions purposeful?', reversed: true, options: PRESERVED },
  { key: 'q3', text: 'Is the child aware of his or her surroundings?', reversed: true, options: PRESERVED },
  { key: 'q4', text: 'Does the child communicate needs and wants?', reversed: true, options: PRESERVED },
  { key: 'q5', text: 'Is the child restless?', reversed: false, options: ABNORMAL },
  { key: 'q6', text: 'Is the child inconsolable?', reversed: false, options: ABNORMAL },
  { key: 'q7', text: 'Is the child underactive, with very little movement while awake?', reversed: false, options: ABNORMAL },
  { key: 'q8', text: 'Does it take the child a long time to respond to interactions?', reversed: false, options: ABNORMAL },
];

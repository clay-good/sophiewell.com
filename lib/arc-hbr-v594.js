...
export function arcHbr(input = {}) {
  ...
  // spec-v1406: age and eGFR join the envelope; an impossible value computed.
  const arcFault = envelopeFault([['ageYears', age], ['hemoglobin', hb], ['eGFR', egfr], ['platelets', plt]]);
  if (arcFault) return arcFault;

...
//
// Neutral topic labels for the ten items. The instrument's verbatim first-person statements are
// proprietary (Rosen and colleagues); these are short topic cues, not the questionnaire's
// statements. Scoring is positional, so shortening the labels cannot change the total or the
// threshold.
export const VHI10_ITEMS = [
  'Being heard by others',
  'Being understood in a noisy room',
  'Personal and social life',
  'Feeling left out of conversations',
  'Lost income',
  'Straining to produce voice',
  'Unpredictable voice clarity',
  'Feeling upset about the voice',
  'Feeling handicapped by the voice',
  'Others asking what is wrong',
];

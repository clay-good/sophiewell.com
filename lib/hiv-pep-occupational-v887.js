...
// spec-v1401 Part B: an optional New York line. Source: NYSDOH AIDS Institute, "PEP to Prevent HIV
// Infection" (hivguidelines.org; updated December 5, 2025; read 2026-09-19), which covers occupational
// exposures: start "ideally within 2 hours of and no later than 72 hours after exposure", a 28-day
// course, and HIV testing at baseline and at 4 and 12 weeks. The guideline names a preferred regimen;
// this tool names no drug, and the line says so rather than breaking that rule.
const NY_LINE = 'New York (NYSDOH AIDS Institute PEP guideline, December 2025): start ideally within 2 hours and no later than 72 hours after the exposure; the course is 28 days; test for HIV at baseline and at 4 and 12 weeks. The guideline names its preferred regimen, which this tool does not print.';
...
export function hivPepOccupational(input = {}) {
  ...
  return {
    ...
    noDrugNote: NO_DRUG_NOTE,
    scopeNote: SCOPE_NOTE,
    nyNote: o.state === 'NY' ? NY_LINE : null,

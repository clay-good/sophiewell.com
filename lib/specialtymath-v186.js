...
export function bedEqd2(input = {}) {
  ...
  const fault = gradeFault([
    ['number of fractions', o.n, null, 100],
    ['dose per fraction (Gy)', o.d, null, 100],
    ['α/β ratio (Gy)', o.ab, null, 100],
  ]);
...
export function pisaEroa(input = {}) {
  ...
  const fault = gradeFault([
    ['PISA radius (cm)', o.r, null, 5],
    ['aliasing velocity (cm/s)', o.va, null, 200],
    ['peak regurgitant velocity (cm/s)', o.vpeak, null, 800],
    ['regurgitant-jet VTI (cm)', o.vti, null, 300],
  ]);
  if (fault) return { valid: false, message: fault };
  if (missing.length) return { valid: false, message: `Enter the ${missing.join(', ')}.` };
...
export function lvWallStress(input = {}) {
  ...
  const fault = gradeFault([
    ['LV pressure (mmHg)', o.p, null, 400],
    ['LV internal radius (cm)', o.r, null, 12],
    ['wall thickness (cm)', o.h, null, 5],
  ]);
  if (fault) return { valid: false, message: fault };
  if (missing.length) return { valid: false, message: `Enter the ${missing.join(', ')}.` };
...
export function dlcoCorrection(input = {}) {
  ...
  const fault = gradeFault([
    ['measured DLCO (mL/min/mmHg)', o.dlco, null, 200],
    ['hemoglobin (g/dL)', o.hb, null, 25],
    ['alveolar volume VA (L)', o.va, null, 12],
  ]);
  if (fault) return { valid: false, message: fault };
  if (missing.length) return { valid: false, message: `Enter the ${missing.join(', ')}.` };

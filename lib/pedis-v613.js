...
export const CATEGORIES = [
  ...
  },
  {
    ...
    grades: [
      ...
      { grade: 2, text: 'Under 1 square centimeter' },
      { grade: 3, text: '1 to 3 square centimeters' },
      { grade: 4, text: 'Over 3 square centimeters' },
    ],
  },
  {
...
export const EXTENT_NOTE = 'EXTENT HAS AN EXPLICIT MEASUREMENT RULE: the largest diameter multiplied by the second largest diameter measured perpendicular to the first, in square centimeters. It is an area, not a length.';

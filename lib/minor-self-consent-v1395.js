...
//   TX Family Code 32.005 (official mirror, read 2026-09-19): a physician, dentist, or psychologist with
//     reasonable grounds to believe a child's condition has been adversely affected by abuse or
//     neglect may examine the child (X-rays, blood tests, photographs) without the consent of the child
//     or the parents, except a child 16 or older who refuses, or where a court order prohibits it.
//
...
//   NJ (FindLaw, current as of January 1, 2024; read 2026-09-19; 9:17A-4 checked word for word against
//   the current text reprinted in Assembly bill A3016, 2024):
...
//
//   Emancipation and marriage (read 2026-09-19), printed as a state note because the form does not
//   ask for them:
//     CA Family Code 7002  married or in a domestic partnership (even if dissolved), on active duty,
//                          or declared emancipated is an emancipated minor; 7050(e)(1) an emancipated
//                          minor consents to medical, dental, or psychiatric care.
//     TX Family Code 1.104 a person married under Texas law, regardless of age, has the capacity and
//                          power of an adult; 31.006 the same after a general removal of disabilities.
//                          The Texas branch used to read an `o.married` that neither the form nor
//                          an agent could supply, and on "yes" answered "a parent consents": the
//                          opposite of 1.104.
//                          32.003(a)(7), a child confined in a TDCJ facility, was a branch on an
//                          `o.confined` nothing supplied either; it is in the note now.
//
...
function tx(o, age) {
  ...
  if (s === 'pregnancy') return { may: true, section: 'Family Code 32.003(a)(4)', text: 'An unmarried, pregnant child may consent to hospital, medical, or surgical care related to the pregnancy, other than abortion.' };
  ...
  if (s === 'sexual-assault') {
    if (age >= 16) return { may: 'conditional', section: 'Family Code 32.005(c)', text: 'A physician with reasonable grounds to believe abuse may examine a child without anyone\'s consent (32.005(a)), but not a child 16 or older who refuses. For the forensic examination, Code of Criminal Procedure 56A.303 takes consent from the minor where 32.003 or 32.005 allows, a person authorized to act for the minor, or the Department of Family and Protective Services.' };
    return { may: 'conditional', section: 'Family Code 32.005(a)', text: 'A physician with reasonable grounds to believe the child\'s condition has been affected by abuse or neglect may examine the child, including X-rays, blood tests, and photographs, without the consent of the child or the parents, unless a court order prohibits it. For the forensic examination, Code of Criminal Procedure 56A.303 also allows consent from a person authorized to act for the minor or the Department of Family and Protective Services.' };
  }
...
function nj(o, age) {
  ...
  if (s === 'mental-health') {
    if (age >= 16) return { may: true, section: 'N.J.S.A. 9:17A-4', text: 'At 16 or older, a minor may consent to temporary outpatient behavioral health care, not including medication, and it is kept confidential.' };
...
const STATE_NOTE = {
  ...
  CA: 'An emancipated minor consents to medical, dental, or psychiatric care without parental consent, knowledge, or liability (Family Code 7050(e)(1)). A minor is emancipated if married or in a domestic partnership, even one since dissolved, on active duty with the Armed Forces, or declared emancipated by a court (7002).',
  TX: 'A minor who has been married under Texas law has the capacity and power of an adult (Family Code 1.104), and so does one whose disabilities of minority were removed for general purposes (31.006). Neither needs a 32.003 ground. A child serving a term of confinement in a Texas Department of Criminal Justice facility may also consent (32.003(a)(7)).',
};

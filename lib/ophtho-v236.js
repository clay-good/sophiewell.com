...
export function randlemanErss(input = {}) {
  ...
  const rangeMsg = gradeFault([
    ['the topography grade', o.topo, 0, 4], ['the residual stromal bed in um', o.rsb, 100, 500],
    ['the age in years', o.age, 10, 90], ['the corneal thickness in um', o.cct, 200, 800],
    ['the MRSE in diopters', o.mrse, -40, 40],
  ]);

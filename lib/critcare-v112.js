...
export function cpisVap(input = {}) {
  ...
  // spec-v1205: the temperature only. The leukocyte count here is PER MM^3 --
  // 12,000 for what BOUNDS.wbc holds as 12 in x10^9/L -- so that envelope would
  // refuse every legitimate value on this tile. An envelope is a claim about a
  // quantity IN A UNIT, and this table's entries are not unit-agnostic.

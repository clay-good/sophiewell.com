...
// Neutral topic labels for the twelve items and their three section stems. The instrument's
// verbatim wording is proprietary (copyright 1995, Allergan); these are short topic cues, not the
// questionnaire's questions. Scoring is positional and key-based, so the labels cannot affect the
// total, the not-applicable handling, or the bands.
export const OSDI_SECTIONS = [
  {
    key: 'symptoms',
    stem: 'Eye symptoms in the last week',
    allowsNotApplicable: false,
    items: [
      { key: 'q1', text: 'Light sensitivity' },
      { key: 'q2', text: 'Gritty feeling' },
      { key: 'q3', text: 'Pain or soreness' },
  ...
  {
    key: 'function',
    stem: 'Activities limited by the eyes in the last week',
    allowsNotApplicable: true,
    items: [
      { key: 'q6', text: 'Reading' },
      { key: 'q7', text: 'Driving at night' },
      { key: 'q8', text: 'Screen work' },
      { key: 'q9', text: 'Watching TV' },
    ],
  },
  {
    key: 'environment',
    stem: 'Environments that felt uncomfortable in the last week',
    allowsNotApplicable: true,
    items: [
      { key: 'q10', text: 'Wind' },
      { key: 'q11', text: 'Dry air' },
      { key: 'q12', text: 'Air conditioning' },
    ],
  },
];

...
//     or two years. (Subject-matter requirements set elsewhere in statute, such as implicit bias,
//     were not read and are not checked.) LVNs are licensed by a different board and not covered.
...
export function nurseLicenseTrainingRequirements(input = {}) {
  ...
  if (o.state !== 'NY') {
    ...
    return {
      ...
      note: o.state === 'CA' ? 'California subject-matter requirements set by statute (for example, implicit bias) are not checked here.' : null,
    };
  }

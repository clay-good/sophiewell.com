...
// A lead shorter than this is not a sentence, it is a fragment: a spelled-out
// acronym ("S.T.O.N.E.") or a bare label. Keep scanning past it.
const MIN_LEAD = 60;
...
export function splitLead(text) {
  ...
  while ((m = re.exec(text)) !== null) {
    ...
    const word = lead.split(/\s+/).pop().toLowerCase();

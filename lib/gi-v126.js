...
export function cdaiCrohns(input = {}) {
  ...
  if (diaryFault) return { valid: false, band: diaryFault, note: CDAI_NOTE };
...
export function uceis(input = {}) {
  ...
  if (fault) return { valid: false, band: fault, note: UCEIS_NOTE };
...
export function ctsiBalthazar(input = {}) {
  ...
  if (fault) return { valid: false, band: fault, note: CTSI_NOTE };

...
export const PH_NOTE = 'The 2022 ESC/ERS guidelines (Humbert M, Kovacs G, Hoeper MM, et al, Eur Heart J 2022;43(38):3618-3731) define pulmonary hypertension as a mean pulmonary arterial pressure above 20 millimetres of mercury at rest. Within that, a wedge pressure at or below 15 with a pulmonary vascular resistance above 2 Wood units is pre-capillary; a wedge pressure above 15 with a resistance at or below 2 is isolated post-capillary; a wedge pressure above 15 with a resistance above 2 is combined pre- and post-capillary; and a wedge pressure at or below 15 with a resistance at or below 2 is unclassified. Two thresholds moved in 2022 and both moved down. The pressure threshold for any pulmonary hypertension fell from 25 or more to above 20, and the resistance cut separating a significant pre-capillary component from none fell from above 3 Wood units to above 2, with resistance becoming a mandatory criterion rather than a supporting number. A tool still using the older figures therefore does two separate wrong things: it calls a mean pressure of 22 normal, and in someone with a raised wedge pressure and a resistance of 2.5 it reports isolated post-capillary disease where the current guideline reports a combined picture, which is a different process and a different treatment conversation. Resistance is calculated here as mean pressure minus wedge pressure divided by cardiac output in litres per minute. It classifies numbers from a right heart catheterisation already performed and it does not start pulmonary vasodilators or decide who should be catheterised.';

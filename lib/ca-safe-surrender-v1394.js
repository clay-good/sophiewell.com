...
//     than 72 hours.
//
// Only California is covered here. New York, New Jersey, and Texas are in safe-haven-infant-check.
//
...
export function caSafeSurrender(input = {}) {
  ...
  return {
    ...
    steps,
    caveats: [...cps.caveats],
    scopeNote: 'California only. For New York, New Jersey, or Texas, use the Safe Haven Infant Check.',

...
export function nacAttrStage(input = {}) {
  ...
  // spec-v1406: the eGFR envelope lib/bounds.js declares; an impossible value staged.
  const egfrFault = boundsAdvisory('eGFR', egfr);
  if (egfrFault) return { valid: false, message: egfrFault };

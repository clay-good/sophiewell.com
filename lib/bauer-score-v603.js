...
export function bauerScore(input = {}) {
  ...
  if (missing.length) {
    return { valid: false, message: `Answer every item. Still needed: ${missing.join(', ')}. Each item scores 1 for the FAVOURABLE state - a higher score means a BETTER prognosis.` };
  }

...
import { r1, r2, inputFault } from './num.js';
...
export function palbi(input = {}) {
  ...
  if (biliMg === null || albuminDl === null || platelets === null) {
    return {
      valid: false,
      message: inputFault([
        ['the bilirubin', o.bilirubin, null, 100, 'mg/dL'],
        ['the albumin', o.albumin, null, 10, 'g/dL'],
        ['the platelet count', o.platelets, null, 3000, '10^9/L'],
      ]),
      note: PALBI_NOTE,
    };
  }
...
export function meldNa(input = {}) {
  ...
  if (bili === null || inr === null || creatRaw === null || sodium === null) {
    return {
      valid: false,
      message: inputFault([
        ['the bilirubin', o.bilirubin, null, 100, 'mg/dL'],
        ...
        ['the sodium', o.sodium, null, 200, 'mmol/L'],
      ]),
      note: MELDNA_NOTE,
    };
  }
...
export function clichy(input = {}) {
  ...
  if (age === null || factorV === null) {
    return {
      valid: false,
      message: inputFault([
        ['the age', o.age, 0, 130, 'years'],
        ['the factor V', o.factorV, 0, 200, 'percent of normal'],
      ]),
      note: CLICHY_NOTE,
    };
  }

...
import { num, r1, r2, inputFault } from './num.js';
...
export function fips(input = {}) {
  ...
  if (bili === null || cr === null || age === null || alb === null) {
    return {
      valid: false,
      message: inputFault([
        ['the total bilirubin', o.bilirubin, null, 100, 'mg/dL'],
        ['the creatinine', o.creatinine, null, 50, 'mg/dL'],
        ['the age', o.age, null, 130, 'years'],
        ['the albumin', o.albumin, null, 10, 'g/dL'],
      ]) || 'Enter total bilirubin (mg/dL), creatinine (mg/dL), age (years), and albumin (g/dL) — all greater than 0.',
    };
  }
...
export function albiPlt(input = {}) {
  ...
  if (bili === null || alb === null || plt === null) {
    return {
      valid: false,
      message: inputFault([
        ['the bilirubin', o.bilirubin, null, 100000, 'micromol/L'],
        ['the albumin', o.albumin, null, 100, 'g/L'],
        ['the platelet count', o.platelets, null, 5000, 'x10^9/L'],
      ]) || 'Enter bilirubin (micromol/L), albumin (g/L), and platelet count (x10^9/L) — all greater than 0.',
    };
  }
  ...
  if (age === null || bili === null || alb === null || plt === null) {
    return {
      ...
      message: inputFault([
        ...
        ['the albumin', o.albumin, null, 100, 'g/L'],
        ['the platelet count', o.platelets, null, 5000, 'x10^9/L'],
      ]) || 'Enter age (years), bilirubin (micromol/L), albumin (g/L), and platelet count (x10^9/L), and mark male sex.',
    };
  }
...
export function fibroq(input = {}) {
  ...
  if (age === null || ast === null || inr === null || alt === null || plt === null) {
    return {
      ...
      message: inputFault([
        ['the age', o.age, null, 130, 'years'],
        ['the AST', o.ast, null, 100000, 'IU/L'],
        ['the INR', o.inr, null, 20, ''],
        ['the ALT', o.alt, null, 100000, 'IU/L'],
        ['the platelet count', o.platelets, null, 5000, 'x10^9/L'],
      ]) || 'Enter age (years), AST, INR, ALT, and platelet count (x10^9/L) — all greater than 0.',
    };
  }

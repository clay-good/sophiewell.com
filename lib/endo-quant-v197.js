...
export function spinaGt(input = {}) {
  ...
  const fault = gradeFault([
    ['TSH (mIU/L)', o.tsh, null, 1000],
    ['free T4 (pmol/L)', o.ft4, null, 200],
  ]);
...
export function homaBeta(input = {}) {
  ...
  const fault = gradeFault([
    ['fasting insulin (µU/mL)', o.insulin, null, 1000],
    ['fasting glucose (mmol/L)', o.glucose, null, 60],
  ]);
  if (fault) return { valid: false, message: fault };
  if (missing.length) return { valid: false, message: `Enter the ${missing.join(', ')}.` };
...
export function oralDispositionIndex(input = {}) {
  ...
  const fault = gradeFault([
    ['fasting (0-min) insulin (µU/mL)', o.i0, null, 1000],
    ['30-min insulin (µU/mL)', o.i30, null, 5000],
    ['fasting (0-min) glucose (mg/dL)', o.g0, null, 1000],
    ['30-min glucose (mg/dL)', o.g30, null, 2000],
  ]);
  if (fault) return { valid: false, message: fault };
  if (missing.length) return { valid: false, message: `Enter the ${missing.join(', ')}.` };

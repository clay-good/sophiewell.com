...
// spec-v1068: an object key is always a string, so `0` and `'0'` were the same
// property written twice. The map accepts arabic or roman input either way.
const ALIAS = { 0: '0', 1: 'I', 2: 'II', 3: 'III', 4: 'IV', I: 'I', II: 'II', III: 'III', IV: 'IV' };

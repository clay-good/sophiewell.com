...
export const META = {
  ...
  aminoglycoside: {
    ...
    example: { fields: { 'ag-drug': 'gentamicin', 'ag-wt': '70', 'ag-crcl': '80' },
               expected: 'Dose 490 mg (7 mg/kg), starting interval q24h. Refuses dialysis / CrCl <20.' },
  },
  ...
  'mgso4-preeclampsia': {
    ...
    example: { fields: { 'mg-load': '4', 'mg-maint': '2', 'mg-conc': '0.04' },
               expected: 'Loading 4 g = 100 mL over 20-30 min; maintenance 2 g/h = 50 mL/h at 40 g/L.' },
  },
  'pca-pump': {

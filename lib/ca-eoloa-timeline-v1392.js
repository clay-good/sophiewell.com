...
// No sunset: SB 403 (Stats. 2025, ch. 315, approved October 3, 2025; leginfo bill history, read
// 2026-09-19) repealed section 443.215 and its January 1, 2031 end date, and leginfo's current text
// of Part 1.85 runs 443 through 443.22 with no sunset section.
//
...
export function caEoloaTimeline(input = {}) {
  ...
  return {
    ...
    requestNote: 'Only the patient may make the requests, never an agent, conservator, or surrogate (443.2(c)). Participation is voluntary for every clinician. The Act no longer has an end date: SB 403 (2025) repealed its 2031 sunset.',

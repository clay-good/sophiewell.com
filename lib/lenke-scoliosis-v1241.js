...
export function lenkeScoliosis(input = {}) {
  ...
  const fault = inputFault([
    ['the proximal thoracic Cobb angle', o.ptCobb, 0, 130, 'degrees'],
    ['the main thoracic Cobb angle', o.mtCobb, 0, 130, 'degrees'],
    ['the thoracolumbar/lumbar Cobb angle', o.tlCobb, 0, 130, 'degrees'],
    ['the proximal thoracic side-bending Cobb angle', o.ptBend, 0, 130, 'degrees'],
    ['the main thoracic side-bending Cobb angle', o.mtBend, 0, 130, 'degrees'],
    ['the thoracolumbar/lumbar side-bending Cobb angle', o.tlBend, 0, 130, 'degrees'],
    ['the T2-T5 kyphosis', o.t2t5, -40, 120, 'degrees'],
    ['the T10-L2 kyphosis', o.t10l2, -40, 120, 'degrees'],
    ['the T5-T12 kyphosis', o.t5t12, -40, 120, 'degrees'],
  ]);

...
export function mayoAdpkd(input = {}) {
  ...
  if (height === null) {
    return { valid: false, message: 'Enter the patient height in metres.' };
  }
  if (Number.isNaN(height)) {
    return { valid: false, message: 'Height must be a number in metres between 0.5 and 2.5.' };
  }

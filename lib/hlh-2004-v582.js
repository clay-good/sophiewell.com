...
// spec-v1234: the cytopenia criterion is a threshold comparison, so past the
...
// blank field is still asked for by name. Haemoglobin is g/dL and platelets are
// x10^9/L, which is the same number as BOUNDS.platelets' x10^3/uL.
...
export function hlh2004(input = {}) {
  ...
  const hlhFault = envelopeFault([['hemoglobin', o.hemoglobin], ['platelets', o.platelets]]);
  if (hlhFault) return hlhFault;

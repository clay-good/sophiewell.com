...
export function mdaccCll(input = {}) {
  ...
  const fault = gradeFault([
    ...
    ['Absolute lymphocyte count (×10⁹/L)', o.alc, 0, 100000],
  ]);
...
export function primaPi(input = {}) {
  ...
  const fault = gradeFault([
    ['Beta-2-microglobulin (mg/L)', o.b2m, 0, 100],
  ]);
  if (fault) return { valid: false, message: fault };
  if (b2m === null) {
...
export function durieSalmon(input = {}) {
  ...
  const fault = gradeFault([
    ['Hemoglobin (g/dL)', o.hemoglobin, 0, 30],
    ['Serum calcium (mg/dL)', o.calcium, 0, 30],
    ['Number of lytic bone lesions', o.boneLesions, 0, 500],
    ['Serum creatinine (mg/dL)', o.creatinine, 0, 50],
  ]);
  if (fault) return { valid: false, message: fault };
...
export function ldt(input = {}) {
  ...
  const fault = gradeFault([
    ['Earlier absolute lymphocyte count (×10⁹/L)', o.alc1, null, 100000],
    ['Later absolute lymphocyte count (×10⁹/L)', o.alc2, null, 100000],
    ['Interval between counts (months)', o.intervalMonths, null, 600],
  ]);
  if (fault) return { valid: false, message: fault };

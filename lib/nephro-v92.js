...
export function ckdStaging({ egfr, uacr, aCategory } = {}) {
  ...
  return {
    ...
    note: `KDIGO heat-map cell ${gStage} x ${aStage}. G-stage by eGFR: G1 >= 90, G2 60-89, G3a 45-59, G3b 30-44, G4 15-29, G5 < 15. A-stage by UACR: A1 < 30, A2 30-300, A3 > 300 mg/g. The risk colour (green/yellow/orange/red) is the KDIGO prognosis for progression and cardiovascular risk, not an individual outcome; confirm an abnormal eGFR/UACR on repeat over >= 3 months for CKD.`,
  };
}

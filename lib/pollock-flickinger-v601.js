...
export function pollockFlickinger(input = {}) {
  ...
  if (volume === null || age === null || site === null) {
    return { valid: false, message: 'Enter the AVM volume in cubic centimetres, the age in years, and the anatomical site. The site is scored differently by the two versions, which is the whole point of the comparison.' };
  }

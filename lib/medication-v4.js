...
export function beersCheck({ ageYears, medications = [], comorbidities = [] }) {
  ...
  if (!Number.isFinite(age)) throw new TypeError('beers-check: ageYears must be a number');
  if (age < 18 || age > 120) throw new RangeError('beers-check: ageYears must be 18-120');

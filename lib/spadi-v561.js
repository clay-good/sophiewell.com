...
//
// ITEMS AND THE SCORING RULE RE-FETCHED, NEVER RECALLED (spec-v97), transcribed from a permission-bearing
// reproduction of the form and verified against an independent rendering with matching item order and
// content:
...
export const SPADI_PAIN_ITEMS = [
  { key: 'painWorst', text: 'At its worst?' },
  { key: 'painLyingOnSide', text: 'When lying on the involved side?' },
  { key: 'painHighShelf', text: 'Reaching for something on a high shelf?' },
  { key: 'painBackOfNeck', text: 'Touching the back of your neck?' },
  { key: 'painPushing', text: 'Pushing with the involved arm?' },
];

export const SPADI_DISABILITY_ITEMS = [
  { key: 'washHair', text: 'Washing your hair?' },
  { key: 'washBack', text: 'Washing your back?' },
  { key: 'pullover', text: 'Putting on an undershirt or pullover sweater?' },
  { key: 'buttonShirt', text: 'Putting on a shirt that buttons down the front?' },
  { key: 'pants', text: 'Putting on your pants?' },
  { key: 'highShelf', text: 'Placing an object on a high shelf?' },
  { key: 'carryHeavy', text: 'Carrying a heavy object of 10 pounds?' },
  { key: 'backPocket', text: 'Removing something from your back pocket?' },
];

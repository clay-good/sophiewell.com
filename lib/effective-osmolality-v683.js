...
export function effectiveOsmolality(input = {}) {
  ...
  const sodiumFault = gradeFault([['Serum sodium (mEq/L)', o.sodium, null, 200]]);
  if (sodiumFault) {
    return { valid: false, code: 'INVALID_INPUT', field: 'sodium', message: sodiumFault, note: EFFECTIVE_OSM_NOTE };
  }

...
export function ecstCarotid(input = {}) {
  ...
  const fault = inputFault([
    ['the narrowest residual lumen', o.residual, null, 20, 'mm'],
    ['the distal internal carotid diameter', o.distalIca, null, 20, 'mm'],
    ['the estimated original diameter at the stenosis', o.originalBulb, null, 30, 'mm'],
  ]);

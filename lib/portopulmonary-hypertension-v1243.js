...
export function portopulmonaryHypertension(input = {}) {
  ...
  const fault = inputFault([
    ['the mean pulmonary artery pressure', o.mpap, null, 120, 'mmHg'],
    ['the pulmonary vascular resistance', o.pvrWood, null, 40, 'Wood units'],
    ['the pulmonary artery wedge pressure', o.wedge, null, 60, 'mmHg'],
  ]);

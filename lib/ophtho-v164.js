...
export function iolPower(input = {}) {
  ...
  const fault = gradeFault([
    ['A-constant', o.aConst, null, 130],
    ['axial length AL (mm)', o.al, null, 40],
    ['average keratometry K (D)', o.k, null, 80],
  ]);
...
export function ocularPerfusionPressure(input = {}) {
  ...
  const fault = gradeFault([
    ['systolic BP (mmHg)', o.sbp, null, 320],
    ['diastolic BP (mmHg)', o.dbp, null, 220],
    ['intraocular pressure IOP (mmHg)', o.iop, null, 90],
  ]);
  if (fault) return { valid: false, message: fault };
  if (missing.length) return { valid: false, message: `Enter the ${missing.join(', ')}.` };

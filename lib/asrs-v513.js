...
// Neutral topic labels for the six Part A items. The screener's verbatim question wording is
// proprietary (copyright World Health Organization); these are short topic cues, not the
// instrument's questions. Scoring is positional -- each item keeps its own countsAt threshold by
// array position -- so the labels cannot change the count or the positive cut.
export const ASRS_ITEMS = [
  { text: 'Finishing the final details of a project', countsAt: 2 },
  { text: 'Getting things in order for an organizing task', countsAt: 2 },
  { text: 'Remembering appointments or obligations', countsAt: 2 },
  { text: 'Putting off tasks that need a lot of thought', countsAt: 3 },
  { text: 'Fidgeting when seated for a long time', countsAt: 3 },
  { text: 'Feeling overly active or driven to keep doing things', countsAt: 3 },
];

...
const POPULATIONS = {
  ...
  'heme-onc': { hb: 7, label: 'a hospitalized adult with a hematologic or oncologic disorder' },
  'acute-coronary-syndrome': { hb: null, label: 'acute coronary syndrome' },
};

const NOTE = 'AABB 2023 restrictive transfusion thresholds (Carson JL et al., JAMA 2023;330(19):1892-1902): transfusion is considered when the hemoglobin falls BELOW the threshold; at or above it a restrictive strategy applies and transfusion is not indicated on the number alone. Hemodynamically stable hospitalized adults (including critically ill) and stable critically ill children: 7 g/dL (strong recommendation, moderate certainty). Hospitalized adults with hematologic or oncologic disorders: 7 g/dL (conditional recommendation, low certainty). Cardiac surgery: 7.5 g/dL; orthopedic surgery or preexisting cardiovascular disease: 8 g/dL. For acute coronary syndrome the guideline makes no restrictive-threshold recommendation (insufficient evidence). Active symptoms of anemia (angina, heart failure, hemodynamic instability) can justify transfusion above the numeric threshold regardless of population — a clinical-judgment override that does not lower the threshold. This reports a guideline threshold comparison, not a diagnosis or a transfusion order.';

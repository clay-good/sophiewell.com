...
// Residency: N.J.S.A. 26:16-11 (FindLaw, current as of January 1, 2024, read 2026-09-19) -- no request
// is granted until the patient gives the attending a copy of one of: an NJ MVC driver's license or
// non-driver ID; proof of NJ voter registration; an NJ resident income tax return for the most recent
// tax year; or any other government record the attending reasonably believes shows current NJ
// residency. The answer lists these; it does not ask which was given.
//
...
export function njMaidTimeline(input = {}) {
  ...
  return {
    ...
    lines,
    secondNote,
    residencyNote: 'Before the request is granted, the patient gives the attending a copy of one proof of New Jersey residency: an MVC driver\'s license or non-driver ID, proof of New Jersey voter registration, a New Jersey resident income tax return for the most recent tax year, or another government record the attending reasonably believes shows current residency (26:16-11).',

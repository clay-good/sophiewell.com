...
export function hcmRiskScd(input = {}) {
  ...
  const fault = gradeFault([
    ['Age (years)', o.age, 16, 120],
    ['Maximal LV wall thickness (mm)', o.wallThickness, 5, 35],
    ['Left-atrial diameter (mm)', o.laDiameter, 20, 80],
    ['Maximal (rest/Valsalva) LVOT gradient (mmHg)', o.lvotGradient, 0, 300],
  ]);
...
export function chargeAf(input = {}) {
  ...
  const fault = gradeFault([
    ['Age (years)', o.age, 18, 120],
    ['Height (cm)', o.height, 100, 250],
    ['Weight (kg)', o.weight, 20, 400],
    ['Systolic BP (mmHg)', o.sbp, 60, 300],
    ['Diastolic BP (mmHg)', o.dbp, 30, 200],
  ]);
  if (fault) return { valid: false, message: fault };

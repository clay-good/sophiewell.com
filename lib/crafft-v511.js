...
// Neutral topic labels for the six items, each keeping its mnemonic word. The screen's verbatim
// question wording is proprietary (copyright Boston Children's Hospital); these are short topic
// cues, not the instrument's questions. Scoring is one point per item by array position, so the
// labels cannot change the total or the positive cut.
export const CRAFFT_ITEMS = [
  { letter: 'C', text: 'CAR: rode with a driver who was high or had been drinking' },
  { letter: 'R', text: 'RELAX: used alcohol or drugs to relax, feel better, or fit in' },
  { letter: 'A', text: 'ALONE: used alcohol or drugs while alone' },
  { letter: 'F', text: 'FORGET: forgot things done while using' },
  { letter: 'F', text: 'FAMILY or FRIENDS: told to cut down' },
  { letter: 'T', text: 'TROUBLE: got into trouble while using' },
];

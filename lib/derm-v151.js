...
export function pasi(input = {}) {
  ...
  return {
    ...
    bandLabel: sev,
    abnormal,
    footing: regionFooting(PASI_REGIONS.length - pasiMissing.length, PASI_REGIONS.length, pasiMissing),
...
export function easi(input = {}) {
  ...
  return {
    ...
    abnormal,
    footing: regionFooting(EASI_REGIONS.length - easiMissing.length, EASI_REGIONS.length, easiMissing),

...
export function hvpg(input = {}) {
  ...
  if (etiology === 'pbc') {
    ...
    if (level === 'csph') notes.push((etiology === null ? 'No cause entered; choose it to settle this. ' : '') + 'Baveno VII states the 10 mmHg CSPH definition for viral- and alcohol-related cirrhosis; other causes need their own reading.');
  }

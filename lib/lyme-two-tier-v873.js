...
export function lymeTwoTier(input = {}) {
  ...
  const action = {
    ...
    'second-tier-pending': `Enter the second-tier result. ${first === 'equivocal' ? 'An equivocal' : 'A positive'} first tier calls for an IgM and IgG immunoblot, or a second, different enzyme immunoassay under the 2019 modified algorithm.`,
    positive: second === 'igg'

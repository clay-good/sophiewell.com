...
export const CHILD_ITEMS = [
  ...
  {
    key: 'c2',
    text: 'How much of a problem is your asthma when you run, exercise or play sports?',
    options: [
      { value: '0', text: '0 - a big problem, I cannot do what I want to do' },
      { value: '1', text: '1 - a problem and I do not like it' },
      { value: '2', text: '2 - a little problem but it is okay' },
      { value: '3', text: '3 - not a problem' },
    ],
  },
  {
    key: 'c3',
    text: 'Do you cough because of your asthma?',
    options: [
  ...
  {
    key: 'c4',
    text: 'Do you wake up during the night because of your asthma?',
    options: [
      { value: '0', text: '0 - yes, all of the time' },
      { value: '1', text: '1 - yes, most of the time' },
      { value: '2', text: '2 - yes, some of the time' },
...
export const PARENT_ITEMS = [
  { key: 'p1', text: 'During the last 4 weeks, how many days did your child have any daytime asthma symptoms?', options: DAYS_OPTIONS },
  { key: 'p2', text: 'During the last 4 weeks, how many days did your child wheeze during the day because of asthma?', options: DAYS_OPTIONS },
  { key: 'p3', text: 'During the last 4 weeks, how many days did your child wake up during the night because of asthma?', options: DAYS_OPTIONS },
];

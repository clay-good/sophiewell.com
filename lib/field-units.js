...
// Companion to WEIGHT_UNITS; canonical (cm) first so every META.example and
// deep-link hash reproduces byte-identically.
...
// A US nurse charts Tmax in °F; unitNum() still returns °C to the compute path.
export const TEMP_UNITS = [
  { unit: '°C', toCanonical: (v) => v },
  { unit: '°F', toCanonical: fToC },
];

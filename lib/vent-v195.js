...
export function ventilatoryRatio(input = {}) {
  ...
  const fault = gradeFault([
    ['measured minute ventilation (mL/min)', o.ve, null, 100000],
    ['measured PaCO₂ (mmHg)', o.paco2, null, 300],
...
export function osi(input = {}) {
  ...
  const fault = gradeFault([
    ['FiO₂ (fraction)', o.fio2, 0.18, 1.0],
    ['mean airway pressure (cmH₂O)', o.map, null, 100],
    ['SpO₂ (%)', o.spo2, 1, 100],
  ]);
  if (fault) return { valid: false, message: fault };
  if (missing.length) return { valid: false, message: `Enter the ${missing.join(', ')}.` };
...
export function ventilationIndex(input = {}) {
  ...
  const fault = gradeFault([
    ['respiratory rate (breaths/min)', o.rr, null, 200],
    ['peak inspiratory pressure (cmH₂O)', o.pip, null, 120],
    ['PaCO₂ (mmHg)', o.paco2, null, 300],
  ]);
  if (fault) return { valid: false, message: fault };
  if (missing.length) return { valid: false, message: `Enter the ${missing.join(', ')}.` };

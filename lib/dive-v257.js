...
const MOD_NOTE = 'Maximum operating depth (nitrox) = 10 x (PO2max / FO2 - 1) meters of sea water, where PO2max is the accepted oxygen partial-pressure limit (typically 1.4 bar working, 1.6 contingency) and FO2 is the oxygen fraction. Below the MOD the inspired PO2 exceeds the CNS oxygen-toxicity limit. A depth limit, not a diagnosis or treatment order.';
...
const EAD_NOTE = 'Equivalent air depth (nitrox) = (depth + 10) x (FN2 / 0.79) - 10 meters, where FN2 = 1 - FO2. It is the air depth giving the same inspired nitrogen partial pressure as the nitrox mix at the actual depth, for use with air decompression tables. A depth value, not a diagnosis or treatment order.';

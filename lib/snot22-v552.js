...
export const SNOT22_ITEMS = [
  ...
  { key: 'poorSleep', text: 'Poor sleep quality' },
...
// Generic 0-5 severity anchors (the instrument's own anchor wording is proprietary).
export const SNOT22_OPTIONS = [
  { value: 0, text: 'None' },
  { value: 1, text: 'Very mild' },
  { value: 2, text: 'Mild' },
  { value: 3, text: 'Moderate' },
  { value: 4, text: 'Severe' },
  { value: 5, text: 'Worst possible' },
];

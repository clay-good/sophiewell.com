...
export function percentPlateletRecovery(input = {}) {
  ...
  const fault = gradeFault([
    ['Pre-transfusion platelet count (x10^9/L)', o.pre, 0, 2000],
    ['Post-transfusion platelet count (x10^9/L)', o.post, 0, 2000],
    ['Blood volume (L)', o.bloodVolume, 1, 12],
    ['Platelets transfused (x10^11)', o.transfused, 0.1, 100],
  ]);
  if (fault) return { valid: false, message: fault };

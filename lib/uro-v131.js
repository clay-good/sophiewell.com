...
export function paduaRenal(input = {}) {
  ...
  if (longitudinal === null || exophytic === null || rim === null || sinus === null || ucs === null || size === null || !faceOk) {
    return { valid: false, message: 'Score the longitudinal location, exophytic rate, renal rim, sinus involvement, collecting-system involvement and tumour size, and choose the anterior/posterior face.' };
  }

...
export function lap(input = {}) {
  ...
  const fault = gradeFault([
    ['Waist circumference (cm)', o.waist, null, 300],
    ['Triglycerides (mmol/L)', o.triglycerides, null, 100],
  ]);
  if (fault) return { valid: false, message: fault };
  if (wc === null || tg === null) {
...
export function vai(input = {}) {
  ...
  const fault = gradeFault([
    ...
    ['BMI (kg/m²)', o.bmi, null, 200],
    ['Triglycerides (mmol/L)', o.triglycerides, null, 100],
    ['HDL cholesterol (mmol/L)', o.hdl, null, 50],
  ]);
  if (fault) return { valid: false, message: fault };
...
export function conicity(input = {}) {
  ...
  const fault = gradeFault([
    ['Waist circumference (cm)', o.waist, null, 300],
    ['Weight (kg)', o.weight, null, 700],
    ['Height (cm)', o.height, null, 300],
  ]);
  if (fault) return { valid: false, message: fault };
...
export function astAltRatio(input = {}) {
  ...
  const fault = gradeFault([
    ['AST (IU/L)', o.ast, null, 100000],
    ['ALT (IU/L)', o.alt, null, 100000],
  ]);
  if (fault) return { valid: false, message: fault };
...
export function ggtPlatelet(input = {}) {
  ...
  const fault = gradeFault([
    ['GGT (IU/L)', o.ggt, null, 100000],
    ['Upper limit of normal for GGT (IU/L)', o.ggtUln, null, 10000],

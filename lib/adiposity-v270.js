...
export function cmi(input = {}) {
  ...
  // spec-v1404: an out-of-range value parsed to null and was asked for as if blank. Name the range
  // instead; a blank still falls through to the ask below.
  const rangeMsg = gradeFault([
    ['the triglycerides', o.tg, 5, 10000],
    ['the HDL cholesterol', o.hdl, 1, 500],
    ['the waist circumference', o.waist, 20, 300],
    ['the height', o.height, 50, 260],
  ]);

...
export const LAB = {
  ...
  albumin: { from: 'g/dL', to: 'g/L', factor: 10 },                  // g/dL * 10
  hemoglobin: { from: 'g/dL', to: 'g/L', factor: 10 },              // g/dL * 10
  magnesium: { from: 'mg/dL', to: 'mmol/L', factor: 1 / 2.43 },      // mg/dL * 0.4115
  bilirubin: { from: 'mg/dL', to: 'umol/L', factor: 17.1 },          // mg/dL * 17.1
  lactate: { from: 'mg/dL', to: 'mmol/L', factor: 1 / 9.008 },       // mg/dL * 0.111 (MW 90.08)
};

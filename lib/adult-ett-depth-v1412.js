...
export function adultEttDepth(input = {}) {
  ...
  if (bySex !== null && byHeight === null) {
    notes.push('Add the height for the height-based estimate: the sex rule is the same mark for every woman and for every man.');
  }
  if (bySex === null) {
    notes.push('Add the sex for the Roberts mark (21 cm women, 23 cm men) alongside this one.');
  }

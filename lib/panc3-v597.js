...
export function panc3(input = {}) {
  ...
  // spec-v1406: the bmi envelope lib/bounds.js declares; an impossible BMI computed.
  const bmiFault = boundsAdvisory('bmi', bmi);
  if (bmiFault) return { valid: false, message: bmiFault };

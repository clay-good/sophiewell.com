...
const CA_INDICATIONS = {
  ...
  hypocalcemia: 'Symptomatic acute hypocalcemia: 1-2 g calcium gluconate IV over 10-20 min, then recheck ionised calcium.',
  citrate: 'Citrate toxicity / massive transfusion: titrate calcium to the ionised calcium; gluconate or chloride per venous access and local protocol.',
};

...
export function rox({ spo2, fio2, rr, hoursAfterStart }) {
  ...
  // spec-v59 §2.6: a non-finite hour reading falls back to the published 12 h
  // window rather than interpolating "NaN" into the band string.
  ...
  const hourStated = hourGiven && Number.isFinite(hrRaw);

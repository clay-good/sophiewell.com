...
export function nyHivHcvTestOffer(input = {}) {
  ...
  if (age < 18 && o.setting !== 'other' && o.risk !== 'yes' && o.risk !== 'no') return { valid: false, message: `Answer whether there is evidence or indication of risk activity. Under ${age < 13 ? '13 the HIV offer' : '18 the hepatitis C offer'} turns on it, and an unanswered one is not a no.` };

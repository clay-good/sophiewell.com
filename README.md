...
Adapting the catalog is incremental. Coverage now stands at **1068 clinical
calculators across 195 `lib` modules** (of 1144 catalog tiles), built module by <!-- catalog-truth:historical (195 is the count of lib modules adapted, not a catalog tile count) -->

...
Adapting the catalog is incremental. Coverage now stands at **489 clinical
calculators across 108 `lib` modules** (of 1109 catalog tiles), built module by <!-- catalog-truth:historical (108 is the count of lib modules adapted, not a catalog tile count) -->

...
Adapting the catalog is incremental. Coverage now stands at **1049 clinical
calculators across 187 `lib` modules** (of 1144 catalog tiles), built module by <!-- catalog-truth:historical (187 is the count of lib modules adapted, not a catalog tile count) -->

...
Adapting the catalog is incremental. Coverage now stands at **1063 clinical
calculators across 192 `lib` modules** (of 1144 catalog tiles), built module by <!-- catalog-truth:historical (192 is the count of lib modules adapted, not a catalog tile count) -->

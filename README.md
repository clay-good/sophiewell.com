...
Adapting the catalog is incremental. Coverage now stands at **572 clinical
calculators across 124 `lib` modules** (of 1109 catalog tiles), built module by <!-- catalog-truth:historical (124 is the count of lib modules adapted, not a catalog tile count) -->

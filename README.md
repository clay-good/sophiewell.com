...
Adapting the catalog is incremental. Coverage now stands at **1066 clinical
calculators across 193 `lib` modules** (of 1144 catalog tiles), built module by <!-- catalog-truth:historical (193 is the count of lib modules adapted, not a catalog tile count) -->

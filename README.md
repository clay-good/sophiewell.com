...
Adapting the catalog is incremental. Coverage now stands at **1038 clinical
calculators across 178 `lib` modules** (of 1137 catalog tiles), built module by <!-- catalog-truth:historical (178 is the count of lib modules adapted, not a catalog tile count) -->

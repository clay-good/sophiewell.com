...
Adapting the catalog is incremental. Coverage now stands at **579 clinical
calculators across 125 `lib` modules** (of 1109 catalog tiles), built module by <!-- catalog-truth:historical (125 is the count of lib modules adapted, not a catalog tile count) -->

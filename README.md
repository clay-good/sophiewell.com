...
Adapting the catalog is incremental. Coverage now stands at **610 clinical
calculators across 130 `lib` modules** (of 1109 catalog tiles), built module by <!-- catalog-truth:historical (130 is the count of lib modules adapted, not a catalog tile count) -->

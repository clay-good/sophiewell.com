...
Adapting the catalog is incremental. Coverage now stands at **565 clinical
calculators across 123 `lib` modules** (of 1109 catalog tiles), built module by <!-- catalog-truth:historical (123 is the count of lib modules adapted, not a catalog tile count) -->

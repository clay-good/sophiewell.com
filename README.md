...
Adapting the catalog is incremental. Coverage now stands at **1039 clinical
calculators across 179 `lib` modules** (of 1137 catalog tiles), built module by <!-- catalog-truth:historical (179 is the count of lib modules adapted, not a catalog tile count) -->

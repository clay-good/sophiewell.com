...
Adapting the catalog is incremental. Coverage now stands at **545 clinical
calculators across 120 `lib` modules** (of 1109 catalog tiles), built module by <!-- catalog-truth:historical (120 is the count of lib modules adapted, not a catalog tile count) -->

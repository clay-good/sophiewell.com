...
Adapting the catalog is incremental. Coverage now stands at **475 clinical
calculators across 105 `lib` modules** (of 1109 catalog tiles), built module by <!-- catalog-truth:historical (105 is the count of lib modules adapted, not a catalog tile count) -->

...
calculators across 184 `lib` modules** (of 1144 catalog tiles), built module by <!-- catalog-truth:historical (184 is the count of lib modules adapted, not a catalog tile count) -->

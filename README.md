...
Adapting the catalog is incremental. Coverage now stands at **1040 clinical
calculators across 180 `lib` modules** (of 1137 catalog tiles), built module by <!-- catalog-truth:historical (180 is the count of lib modules adapted, not a catalog tile count) -->

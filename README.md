...
Adapting the catalog is incremental. Coverage now stands at **1067 clinical
calculators across 194 `lib` modules** (of 1144 catalog tiles), built module by <!-- catalog-truth:historical (194 is the count of lib modules adapted, not a catalog tile count) -->

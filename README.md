...
Adapting the catalog is incremental. Coverage now stands at **505 clinical
calculators across 114 `lib` modules** (of 1109 catalog tiles), built module by <!-- catalog-truth:historical (114 is the count of lib modules adapted, not a catalog tile count) -->

...
Adapting the catalog is incremental. Coverage now stands at **538 clinical
calculators across 119 `lib` modules** (of 1109 catalog tiles), built module by <!-- catalog-truth:historical (119 is the count of lib modules adapted, not a catalog tile count) -->

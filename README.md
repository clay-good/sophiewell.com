...
Adapting the catalog is incremental. Coverage now stands at **1045 clinical
calculators across 185 `lib` modules** (of 1144 catalog tiles), built module by <!-- catalog-truth:historical (185 is the count of lib modules adapted, not a catalog tile count) -->

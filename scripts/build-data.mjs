...
const v4Datasets = [
  ...
  v4TableDataset({
    id: 'dmepos', label: 'DMEPOS Fee Schedule subset',
    sourceUrl: 'https://www.cms.gov/medicare/medicare-fee-for-service-payment/dmeposfeesched',
    agency: 'CMS', status: 'public-domain', cadence: 'quarterly', shardName: 'dmepos.json',
    seed: [
      { hcpcs: 'E0114', description: 'Crutches underarm aluminum', cbState: { CA: 36.50, TX: 35.10, NY: 38.20 }, nonCb: 39.10 },
      { hcpcs: 'E0260', description: 'Hospital bed semi-electric', cbState: { CA: 96.40, TX: 92.10, NY: 99.30 }, nonCb: 102.40 },
      { hcpcs: 'E1390', description: 'Oxygen concentrator stationary', cbState: { CA: 70.20, TX: 68.10, NY: 73.40 }, nonCb: 76.20 },
      { hcpcs: 'K0001', description: 'Standard wheelchair', cbState: { CA: 42.10, TX: 40.50, NY: 44.20 }, nonCb: 46.50 },
    ],
  }),
  v4TableDataset({
    id: 'clfs', label: 'CMS Clinical Laboratory Fee Schedule subset',
    sourceUrl: 'https://www.cms.gov/medicare/medicare-fee-for-service-payment/clinicallabfeesched',
    agency: 'CMS', status: 'public-domain', cadence: 'quarterly', shardName: 'clfs.json',
    seed: [
      { hcpcs: '80048', description: 'Basic metabolic panel (Calcium, total)', nationalLimitationAmount: 8.50 },
      { hcpcs: '80053', description: 'Comprehensive metabolic panel', nationalLimitationAmount: 11.91 },
      { hcpcs: '80061', description: 'Lipid panel', nationalLimitationAmount: 13.39 },
      { hcpcs: '83036', description: 'Hemoglobin, glycosylated (A1C)', nationalLimitationAmount: 9.43 },
      { hcpcs: '85025', description: 'Blood count complete (CBC)', nationalLimitationAmount: 7.77 },
    ],
  }),
  v4TableDataset({
    id: 'asp', label: 'ASP Drug Pricing subset',
    sourceUrl: 'https://www.cms.gov/medicare/medicare-part-b-drug-average-sales-price/asp-pricing-files',
    agency: 'CMS', status: 'public-domain', cadence: 'quarterly', shardName: 'asp.json',
    seed: [
      { hcpcs: 'J1885', description: 'Ketorolac per 15 mg', perUnit: 0.66 },
      { hcpcs: 'J2270', description: 'Morphine sulfate up to 10 mg', perUnit: 0.94 },
      { hcpcs: 'J0696', description: 'Ceftriaxone sodium per 250 mg', perUnit: 1.31 },
      { hcpcs: 'J2543', description: 'Piperacillin/tazobactam 1.125 g', perUnit: 1.94 },
      { hcpcs: 'J7050', description: 'Normal saline 250 mL', perUnit: 0.71 },
    ],
  }),
  v4TableDataset({
    id: 'asc', label: 'ASC Payment subset',
    sourceUrl: 'https://www.cms.gov/medicare/medicare-fee-for-service-payment/ascpayment',
    agency: 'CMS', status: 'public-domain', cadence: 'quarterly', shardName: 'asc.json',
    seed: [
      { hcpcs: '66984', description: 'Cataract surgery w/IOL', paymentIndicator: 'J8', rate: 1059.00 },
      { hcpcs: '29881', description: 'Knee arthroscopy w/meniscectomy', paymentIndicator: 'J8', rate: 1894.00 },
      { hcpcs: '45378', description: 'Diagnostic colonoscopy', paymentIndicator: 'J8', rate: 692.00 },
      { hcpcs: '64483', description: 'Lumbar transforaminal epidural', paymentIndicator: 'J8', rate: 519.00 },
    ],
  }),
  v4TableDataset({
    id: 'wage-index', label: 'CMS Wage Index subset (CBSA)',
    sourceUrl: 'https://www.cms.gov/medicare/payment/prospective-payment-systems/acute-inpatient-pps/wage-index',
    agency: 'CMS', status: 'public-domain', cadence: 'annual', shardName: 'wage-index.json',
    seed: [
      { cbsa: '31080', name: 'Los Angeles-Long Beach-Anaheim, CA', wageIndex: 1.2103 },
      { cbsa: '35620', name: 'New York-Newark-Jersey City, NY-NJ-PA', wageIndex: 1.3094 },
      { cbsa: '16980', name: 'Chicago-Naperville-Elgin, IL-IN-WI', wageIndex: 1.0319 },
      { cbsa: '19100', name: 'Dallas-Fort Worth-Arlington, TX', wageIndex: 0.9764 },
      { cbsa: '47900', name: 'Washington-Arlington-Alexandria, DC-VA-MD-WV', wageIndex: 1.0801 },
    ],
  }),
  v4TableDataset({
    id: 'gpci', label: 'CMS GPCI table',
    sourceUrl: 'https://www.cms.gov/medicare/payment/fee-schedules/physician/pfs-relative-value-files',
    agency: 'CMS', status: 'public-domain', cadence: 'annual', shardName: 'gpci.json',
    seed: [
      { localityCode: '0000099', name: 'Rest of US', work: 1.000, pe: 0.876, mp: 0.434 },
      { localityCode: '0500005', name: 'San Francisco, CA', work: 1.073, pe: 1.353, mp: 0.379 },
      { localityCode: '3100002', name: 'NYC Suburbs, NY', work: 1.058, pe: 1.180, mp: 1.622 },
      { localityCode: '0900100', name: 'Hartford, CT', work: 1.020, pe: 1.067, mp: 0.835 },
      { localityCode: '5500200', name: 'Seattle, WA', work: 1.016, pe: 1.130, mp: 0.799 },
    ],
  }),
  v4TableDataset({
    id: 'cms-deductibles', label: 'Medicare deductibles & premiums',
    sourceUrl: 'https://www.cms.gov/newsroom/fact-sheets/2026-medicare-parts-b-premiums-and-deductibles',
    agency: 'CMS', status: 'public-domain', cadence: 'annual', shardName: 'deductibles.json',
    seed: {
      year: 2026,
      partA: { inpatientDeductible: 1676, daysCoinsurance61to90: 419, daysCoinsurance91plus: 838 },
      partB: { deductible: 257, baselinePremium: 185.00 },
    },
  }),
  v4TableDataset({
    id: 'irmaa', label: 'Medicare IRMAA brackets',
    sourceUrl: 'https://www.ssa.gov/medicare/lis/income-limits',
    agency: 'CMS / SSA', status: 'public-domain', cadence: 'annual', shardName: 'irmaa.json',
    seed: {
      year: 2026,
      filingStatus: {
        single: [
          { from: 0, to: 106000, partBSurcharge: 0.00, partDSurcharge: 0.00 },
          { from: 106000, to: 133000, partBSurcharge: 74.00, partDSurcharge: 13.70 },
          { from: 133000, to: 167000, partBSurcharge: 185.00, partDSurcharge: 35.30 },
          { from: 167000, to: 200000, partBSurcharge: 295.90, partDSurcharge: 57.00 },
          { from: 200000, to: 500000, partBSurcharge: 406.90, partDSurcharge: 78.60 },
          { from: 500000, to: null, partBSurcharge: 443.90, partDSurcharge: 85.80 },
        ],
        joint: [
          { from: 0, to: 212000, partBSurcharge: 0.00, partDSurcharge: 0.00 },
          { from: 212000, to: 266000, partBSurcharge: 74.00, partDSurcharge: 13.70 },
          { from: 266000, to: 334000, partBSurcharge: 185.00, partDSurcharge: 35.30 },
          { from: 334000, to: 400000, partBSurcharge: 295.90, partDSurcharge: 57.00 },
          { from: 400000, to: 750000, partBSurcharge: 406.90, partDSurcharge: 78.60 },
          { from: 750000, to: null, partBSurcharge: 443.90, partDSurcharge: 85.80 },
        ],
      },
    },
  }),
  v4TableDataset({
    id: 'aca-thresholds', label: 'ACA Marketplace thresholds',
    sourceUrl: 'https://www.cms.gov/cciio/resources/regulations-and-guidance',
    agency: 'CMS / HHS', status: 'public-domain', cadence: 'annual', shardName: 'aca.json',
    seed: {
      year: 2026,
      oopMaxSelf: 9450,
      oopMaxFamily: 18900,
      avBands: { Bronze: [0.58, 0.62], Silver: [0.68, 0.72], Gold: [0.78, 0.82], Platinum: [0.88, 0.92] },
    },
  }),
  v4TableDataset({
    id: 'hsa-fsa-limits', label: 'HSA / FSA / HDHP limits',
    sourceUrl: 'https://www.irs.gov/pub/irs-drop/rp-25-19.pdf',
    agency: 'IRS', status: 'government-work', cadence: 'annual', shardName: 'hsa-fsa.json',
    seed: {
      year: 2026,
      hsa: { contributionSelf: 4400, contributionFamily: 8750, catchUp55: 1000 },
      hdhp: { minDeductibleSelf: 1700, minDeductibleFamily: 3400, maxOopSelf: 8500, maxOopFamily: 17000 },
      fsa: { healthFsa: 3300, healthFsaCarryover: 660, dependentCare: 5000 },
    },
  }),
  v4TableDataset({
    id: 'fpl', label: 'HHS Federal Poverty Guidelines',
    sourceUrl: 'https://aspe.hhs.gov/topics/poverty-economic-mobility/poverty-guidelines',
    agency: 'HHS / ASPE', status: 'public-domain', cadence: 'annual', shardName: 'fpl.json',
    seed: {
      year: 2026,
      contiguous48: { base: 15650, perAdditional: 5500 },
      alaska:        { base: 19550, perAdditional: 6880 },
      hawaii:        { base: 17990, perAdditional: 6320 },
    },
  }),
  v4TableDataset({
    id: 'irs-mileage', label: 'IRS medical mileage rate',
    sourceUrl: 'https://www.irs.gov/tax-professionals/standard-mileage-rates',
    agency: 'IRS', status: 'government-work', cadence: 'annual', shardName: 'mileage.json',
    seed: [
      { year: 2026, business: 0.700, medical: 0.210, charitable: 0.140, moving: 0.210 },
      { year: 2025, business: 0.670, medical: 0.210, charitable: 0.140, moving: 0.210 },
      { year: 2024, business: 0.670, medical: 0.210, charitable: 0.140, moving: 0.210 },
    ],
  }),
  v4TableDataset({
    id: 'dea-rules', label: 'DEA Registration Number Rules',
    sourceUrl: 'https://www.deadiversion.usdoj.gov/',
    agency: 'DEA', status: 'public-domain', cadence: 'static', shardName: 'rules.json',
    seed: {
      validRegistrantLetters: ['A','B','F','G','M','P','R','X'],
      checksumRule: 'sum1 = digits[1]+digits[3]+digits[5]; sum2 = 2*(digits[2]+digits[4]+digits[6]); checkDigit = lastDigitOf(sum1+sum2)',
    },
  }),
  v4TableDataset({
    id: 'nucc-taxonomy', label: 'NUCC Health Care Provider Taxonomy subset',
    sourceUrl: 'https://nucc.org/index.php/code-sets-mainmenu-41/provider-taxonomy-mainmenu-40',
    agency: 'NUCC', status: 'public-domain', cadence: 'semi-annual', shardName: 'taxonomy.json',
    seed: [
      { code: '207Q00000X', type: 'Allopathic & Osteopathic Physicians', classification: 'Family Medicine', specialization: '' },
      { code: '208D00000X', type: 'Allopathic & Osteopathic Physicians', classification: 'General Practice', specialization: '' },
      { code: '207RC0000X', type: 'Allopathic & Osteopathic Physicians', classification: 'Internal Medicine', specialization: 'Cardiovascular Disease' },
      { code: '2084N0400X', type: 'Allopathic & Osteopathic Physicians', classification: 'Psychiatry & Neurology', specialization: 'Neurology' },
      { code: '363L00000X', type: 'Physician Assistants & Advanced Practice Nursing Providers', classification: 'Nurse Practitioner', specialization: '' },
      { code: '363A00000X', type: 'Physician Assistants & Advanced Practice Nursing Providers', classification: 'Physician Assistant', specialization: '' },
    ],
  }),
  v4TableDataset({
    id: 'acip-routine-adult', label: 'ACIP Routine Adult Immunization Schedule',
    sourceUrl: 'https://www.cdc.gov/vaccines/hcp/imz-schedules/adult-age.html',
    agency: 'CDC ACIP', status: 'public-domain', cadence: 'annual', shardName: 'adult.json',
    seed: [
      { vaccine: 'Influenza', ageBand: '19+', recommendation: 'Annual; 1 dose' },
      { vaccine: 'Td/Tdap', ageBand: '19+', recommendation: 'Tdap once then Td or Tdap booster every 10 years' },
      { vaccine: 'Zoster (RZV)', ageBand: '50+', recommendation: '2 doses, 2-6 months apart' },
      { vaccine: 'Pneumococcal (PCV20)', ageBand: '50+', recommendation: '1 dose if not previously vaccinated' },
      { vaccine: 'COVID-19', ageBand: '19+', recommendation: 'Per current CDC schedule' },
      { vaccine: 'HPV', ageBand: '19-26', recommendation: '2 or 3 doses based on age at initiation' },
    ],
  }),
  v4TableDataset({
    id: 'acip-routine-child', label: 'ACIP Routine Child Immunization Schedule',
    sourceUrl: 'https://www.cdc.gov/vaccines/hcp/imz-schedules/child-adolescent-age.html',
    agency: 'CDC ACIP', status: 'public-domain', cadence: 'annual', shardName: 'child.json',
    seed: [
      { vaccine: 'HepB', dose: 1, atAge: 'Birth' },
      { vaccine: 'HepB', dose: 2, atAge: '1-2 mo' },
      { vaccine: 'HepB', dose: 3, atAge: '6-18 mo' },
      { vaccine: 'DTaP', dose: 1, atAge: '2 mo' },
      { vaccine: 'DTaP', dose: 4, atAge: '15-18 mo' },
      { vaccine: 'MMR', dose: 1, atAge: '12-15 mo' },
      { vaccine: 'MMR', dose: 2, atAge: '4-6 yr' },
      { vaccine: 'Varicella', dose: 1, atAge: '12-15 mo' },
    ],
  }),
  v4TableDataset({
    id: 'acip-catchup', label: 'ACIP Catch-up Immunization Schedule',
    sourceUrl: 'https://www.cdc.gov/vaccines/hcp/imz-schedules/child-catchup.html',
    agency: 'CDC ACIP', status: 'public-domain', cadence: 'annual', shardName: 'catchup.json',
    seed: [
      { vaccine: 'HepB', minIntervalDoses: { '1to2': '4 wk', '2to3': '8 wk and at least 16 wk after dose 1, no earlier than 24 wk of age' } },
      { vaccine: 'DTaP', minIntervalDoses: { '1to2': '4 wk', '2to3': '4 wk', '3to4': '6 mo', '4to5': '6 mo (if <4 yo at dose 4)' } },
      { vaccine: 'MMR', minIntervalDoses: { '1to2': '4 wk' } },
      { vaccine: 'Varicella', minIntervalDoses: { '1to2': '3 mo if <13 yo; 4 wk if >=13 yo' } },
    ],
  }),
  v4TableDataset({
    id: 'yellow-book', label: 'CDC Yellow Book country reference subset',
    sourceUrl: 'https://wwwnc.cdc.gov/travel/yellowbook',
    agency: 'CDC', status: 'public-domain', cadence: 'annual', shardName: 'yellow-book.json',
    seed: [
      { country: 'India', recommendedVaccines: ['Hep A', 'Typhoid', 'Hep B'], malariaProphylaxis: 'Recommended in many areas (regimen varies)', foodWater: 'Use bottled or treated water; avoid raw produce', altitude: 'Variable' },
      { country: 'Kenya', recommendedVaccines: ['Yellow Fever (often required)', 'Hep A', 'Typhoid'], malariaProphylaxis: 'Recommended outside Nairobi at high elevations', foodWater: 'Use bottled water', altitude: 'Up to 2000+ m in highlands' },
      { country: 'Peru', recommendedVaccines: ['Hep A', 'Typhoid', 'Yellow Fever (jungle areas)'], malariaProphylaxis: 'Recommended in jungle below 2000 m', foodWater: 'Use bottled water', altitude: 'Cusco ~3400 m; counsel acute mountain sickness' },
      { country: 'Thailand', recommendedVaccines: ['Hep A', 'Typhoid'], malariaProphylaxis: 'Limited rural areas only', foodWater: 'Use bottled water', altitude: 'Mostly low' },
    ],
  }),
  v4TableDataset({
  ...
  v4TableDataset({
    id: 'medicaid-state', label: 'Medicaid eligibility thresholds by state',
    sourceUrl: 'state Medicaid agency files; see docs/data-sources.md for per-state URLs',
    agency: 'state Medicaid agencies (numeric only)', status: 'numeric-facts-with-attribution',
    cadence: 'semi-annual', shardName: 'states.json',
    seed: [
      { state: 'CA', expansion: true, adultFplPct: 138, pregnantFplPct: 213, chipFplPct: 266, applicationUrl: 'https://www.coveredca.com/' },
      { state: 'TX', expansion: false, adultFplPct: 17, pregnantFplPct: 203, chipFplPct: 206, applicationUrl: 'https://yourtexasbenefits.com/' },
      { state: 'FL', expansion: false, adultFplPct: 32, pregnantFplPct: 196, chipFplPct: 215, applicationUrl: 'https://www.myflfamilies.com/' },
      { state: 'NY', expansion: true, adultFplPct: 138, pregnantFplPct: 223, chipFplPct: 405, applicationUrl: 'https://nystateofhealth.ny.gov/' },
      { state: 'IL', expansion: true, adultFplPct: 138, pregnantFplPct: 213, chipFplPct: 318, applicationUrl: 'https://abe.illinois.gov/' },
      { state: 'PA', expansion: true, adultFplPct: 138, pregnantFplPct: 220, chipFplPct: 319, applicationUrl: 'https://www.compass.state.pa.us/' },
    ],
  }),
  v4TableDataset({
    id: 'va-eligibility', label: 'VA eligibility quick categories',
    sourceUrl: 'https://www.va.gov/health-care/eligibility/', agency: 'VA', status: 'public-domain',
    cadence: 'annual', shardName: 'va.json',
    seed: [
      { priorityGroup: 1, summary: 'Service-connected disability rating 50%+ or unemployable', copay: 'No copays for care' },
      { priorityGroup: 2, summary: 'Service-connected 30-40%', copay: 'No copays for SC conditions' },
      { priorityGroup: 4, summary: 'Catastrophically disabled or housebound', copay: 'Limited copays' },
      { priorityGroup: 6, summary: 'OEF/OIF/OND combat veterans within 5 yr; Agent Orange exposure; Gulf War', copay: 'Varies' },
      { priorityGroup: 8, summary: 'Income above thresholds; non-service-connected', copay: 'Higher copays apply' },
    ],
  }),
  v4TableDataset({
    id: 'tricare-plans', label: 'TRICARE plan rules',
    sourceUrl: 'https://www.tricare.mil/Plans', agency: 'DHA TRICARE', status: 'public-domain',
    cadence: 'annual', shardName: 'tricare.json',
    seed: [
      { plan: 'TRICARE Prime', whoQualifies: 'Active duty (mandatory) and family in Prime Service Area', referralRequired: true },
      { plan: 'TRICARE Select', whoQualifies: 'Most non-active-duty beneficiaries', referralRequired: false },
      { plan: 'TRICARE For Life', whoQualifies: 'Medicare-eligible TRICARE beneficiaries (typically 65+)', referralRequired: false, note: 'Wraparound to Medicare' },
      { plan: 'TRICARE Reserve Select', whoQualifies: 'Selected Reserve members not on active duty', referralRequired: false },
      { plan: 'TRICARE Young Adult', whoQualifies: 'Adult dependents 21-26 not eligible elsewhere', referralRequired: 'Plan-dependent' },
    ],
  }),
  v4TableDataset({
    id: 'ihs-eligibility', label: 'IHS eligibility quick reference',
    sourceUrl: 'https://www.ihs.gov/forpatients/faq/', agency: 'IHS', status: 'public-domain',
    cadence: 'annual', shardName: 'ihs.json',
    seed: {
      generalRules: [
        'Members of federally recognized American Indian or Alaska Native tribes are generally eligible.',
        'Some non-Indian individuals may receive care under specific circumstances at certain facilities.',
        'Tribal-specific rules at tribally operated facilities vary; this card is generic IHS direct-care eligibility.',
      ],
      acceptedDocumentation: [
        'Tribal enrollment card or letter from a federally recognized tribe',
        'Certificate of Degree of Indian or Alaska Native Blood (CDIB)',
        'Other proof of descent from a federally recognized tribe member',
      ],
    },
  }),
  v4TableDataset({
  ...
  v4TableDataset({
    id: 'drug-recalls', label: 'FDA drug recalls (weekly snapshot)',
    sourceUrl: 'https://api.fda.gov/drug/enforcement.json', agency: 'FDA', status: 'public-domain',
    cadence: 'weekly', shardName: 'recalls.json',
    seed: [
      { product: 'Acetaminophen 500 mg tablets', ndc: '00000-0001-01', recallClass: 'II', reason: 'Sub-potent results during stability', recallDate: '2026-04-12', firm: 'Example Pharma' },
      { product: 'Lisinopril 10 mg tablets',     ndc: '00000-0002-01', recallClass: 'III', reason: 'Labeling error (incorrect lot number on bottle)', recallDate: '2026-03-30', firm: 'Example Generics' },
      { product: 'Metformin 500 mg ER tablets',   ndc: '00000-0003-01', recallClass: 'II', reason: 'NDMA above acceptable daily intake', recallDate: '2026-02-15', firm: 'Example Mfg' },
    ],
  }),
  v4TableDataset({
    id: 'vaccine-lot-recalls', label: 'FDA / CDC vaccine lot recalls',
    sourceUrl: 'https://www.fda.gov/safety/recalls-market-withdrawals-safety-alerts',
    agency: 'FDA / CDC', status: 'public-domain', cadence: 'as-issued', shardName: 'recalls.json',
    seed: [
      { vaccine: 'Influenza (example)', lot: 'X1234A', reason: 'Loss of cold-chain in distribution', recallDate: '2025-11-10', firm: 'Example Bio' },
    ],
  }),
];

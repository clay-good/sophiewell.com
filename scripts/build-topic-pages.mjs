...
export const TOPICS = {
  ...
  'billing-and-coding': {
    ...
    description: 'Free medical billing and coding calculators: Medicare MPFS payment, NCCI and MUE claim edits, E/M leveling, infusion and drug units, patient cost-share, NPI/MBI validation, and DRG and APC pricing.',

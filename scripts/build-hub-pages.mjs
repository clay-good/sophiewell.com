...
export const HUBS = {
  patients: {
    ...
    title: 'Healthcare Tools for Patients · Sophie Well',
  ...
  billers: {
    ...
    title: 'Medical Billing and Coding Tools · Sophie Well',
  ...
  clinicians: {
    ...
    title: 'Clinical Calculators and References · Sophie Well',

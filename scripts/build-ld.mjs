  ...
  '@graph': [
    ...
    },
    {
      ...
      mainEntity: [
        ...
        { '@type': 'Question', name: 'Is Sophie Well safe to use with patient data?', acceptedAnswer: { '@type': 'Answer', text: 'Every calculation runs locally in your browser. Data is sent only when you deliberately submit a problem report after the dialog explains which context categories apply. Do not put patient identifiers in a report. The site has no analytics or background telemetry.' } },
        ...
        { '@type': 'Question', name: 'Is Sophie Well HIPAA compliant?', acceptedAnswer: { '@type': 'Answer', text: "HIPAA obligations depend on your organization and workflow. Calculations run locally, but problem reports are transmitted to the maintainer and are not designed or approved to receive PHI. Never include patient identifiers in a report; your organization's policies govern use with patient data." } },
        ...
        { '@type': 'Question', name: 'How do I report a bug or wrong answer?', acceptedAnswer: { '@type': 'Answer', text: 'Open the tool and choose Report a problem beside its name. The dialog explains which context categories will be sent. Sensitive tools send no form entries, generated text, query parameters, or URL state. Add what you expected, but never include patient identifiers.' } },

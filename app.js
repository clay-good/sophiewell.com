...
import { renderers as RV453 } from './views/group-v453.js';
...
const UTILITIES = [
  ...
  { id: 'schatzker',               name: 'Schatzker Classification (Tibial Plateau Fracture)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },

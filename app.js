...
import { renderers as RV507 } from './views/group-v507.js';
...
const UTILITIES = [
  ...
  { id: 'hearing-loss-degree',      name: 'Degree of Hearing Loss (Pure-Tone Average)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },

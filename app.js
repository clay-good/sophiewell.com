...
import { renderers as RV1440 } from './views/group-v1440.js';
import { renderers as RV1441 } from './views/group-v1441.js';
import { renderers as RV1442 } from './views/group-v1442.js';
import { renderers as RV1443 } from './views/group-v1443.js';
import { renderers as RV1444 } from './views/group-v1444.js';
...
import { renderers as RV1455 } from './views/group-v1455.js';
...
import { renderers as RV1475 } from './views/group-v1475.js';
import { renderers as RV1476 } from './views/group-v1476.js';
import { renderers as RV1479 } from './views/group-v1479.js';
import { renderers as RV1480 } from './views/group-v1480.js';
import { renderers as RV1481 } from './views/group-v1481.js';
...
import { renderers as RV1486 } from './views/group-v1486.js';
import { renderers as RV1487 } from './views/group-v1487.js';
import { renderers as RV1488 } from './views/group-v1488.js';
import { renderers as RV1489 } from './views/group-v1489.js';
import { renderers as RV1490 } from './views/group-v1490.js';
import { renderers as RV1491 } from './views/group-v1491.js';
import { renderers as RV1492 } from './views/group-v1492.js';
import { renderers as RV1493 } from './views/group-v1493.js';
import { renderers as RV1494 } from './views/group-v1494.js';
import { renderers as RV1495 } from './views/group-v1495.js';
import { renderers as RV1496 } from './views/group-v1496.js';
import { renderers as RV1497 } from './views/group-v1497.js';
import { renderers as RV1498 } from './views/group-v1498.js';
import { renderers as RV1499 } from './views/group-v1499.js';
import { renderers as RV1570 } from './views/group-v1570.js';
...
const UTILITIES = [
  ...
  { id: 'partd-coverage-clock', name: 'Part D Coverage Decision Clock', group: 'C', audiences: ['billers', 'patients', 'clinicians'], clinical: false },
  ...
  { id: 'partb-late-penalty', name: 'Part B Late Enrollment Penalty', group: 'C', audiences: ['billers', 'patients', 'clinicians'], clinical: false },
  { id: 'partd-late-penalty', name: 'Part D Late Enrollment Penalty', group: 'C', audiences: ['billers', 'patients', 'clinicians'], clinical: false },
  ...
  { id: 'copay-card-runout', name: 'Copay Card Run-Out and Accumulator Impact', group: 'Q', audiences: ['billers', 'patients', 'clinicians'], clinical: false },
  { id: 'partd-mfp-price-check', name: 'Medicare Negotiated Drug Price Check', group: 'Q', audiences: ['billers', 'patients', 'clinicians'], clinical: false },
  { id: 'agb-percentage', name: 'Amounts Generally Billed (AGB) Percentage', group: 'C', audiences: ['billers', 'patients'], clinical: false },
  { id: 'fap-collection-clock', name: 'Collection Action Timeline (501(r))', group: 'C', audiences: ['billers', 'patients'], clinical: false },
  { id: 'fap-discount', name: 'Financial Assistance Discount (Sliding Scale)', group: 'C', audiences: ['billers', 'patients'], clinical: false },
  ...
  { id: 'irf-compliance-clock', name: 'Inpatient Rehabilitation Timing Check', group: 'H', audiences: ['clinicians', 'billers'], clinical: false },
  { id: 'mcsn-appeal-rights', name: 'Inpatient-to-Observation Appeal Rights (MCSN)', group: 'H', audiences: ['clinicians', 'billers', 'patients'], clinical: false },
  { id: 'compounding-bud', name: 'Compounded Preparation Beyond-Use Date', group: 'Q', audiences: ['clinicians'], clinical: false },
  { id: 'extra-help-msp-screen', name: 'Extra Help and Medicare Savings Program Screen', group: 'C', audiences: ['billers', 'patients', 'clinicians'], clinical: false },
  { id: 'hospice-aggregate-cap', name: 'Hospice Aggregate Cap', group: 'H', audiences: ['billers', 'clinicians'], clinical: false },
  { id: 'im-notice-timing', name: 'Important Message from Medicare Timing', group: 'H', audiences: ['clinicians', 'billers', 'patients'], clinical: false },
  ...
  { id: 'adult-ett-depth', name: 'Adult ETT Depth (Lip Corner)', group: 'I', audiences: ['clinicians', 'educators', 'field'], clinical: true },
  ...
  // spec-v1393: controlled substances (Group M). views/group-v1393.js, lib/<id>-v1393.js,
  // mcp/adapters/<id>-v1393.js.
  ...
  { id: 'moon-deadline', name: 'Observation Notice (MOON) Deadline', group: 'H', audiences: ['clinicians', 'billers', 'patients'], clinical: false },
  { id: 'nomnc-deadline', name: 'NOMNC Delivery Deadline', group: 'H', audiences: ['clinicians', 'billers', 'patients'], clinical: false },
  { id: 'snf-qualifying-stay', name: 'SNF Qualifying Stay and Benefit Days', group: 'H', audiences: ['clinicians', 'billers', 'patients'], clinical: false },
  { id: 'hospice-period-clock', name: 'Hospice Benefit Period Clock', group: 'H', audiences: ['clinicians', 'billers', 'patients'], clinical: false },
  ...
  { id: 'reportable-condition-urgency', name: 'Reportable Disease: Report Now or Later? (NY, NJ, CA, TX)', group: 'M', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'safe-haven-infant-check', name: 'Safe Haven Infant Check (NY, NJ, TX)', group: 'M', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'wellens-criteria', name: 'Wellens Syndrome Criteria (ECG)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'de-winter-pattern', name: 'de Winter Pattern (STEMI Equivalent)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  // spec-v917: the three phases of the WHO Surgical Safety Checklist. The result names the
  // incomplete PHASE, because "the time out" is one phase of three and Sign Out is the one
  ...
  // spec-v919: the Just Culture behaviors. The outcome is collected and then reported as
  // having changed nothing, which is the point of the page. views/group-v919.js,
  // lib/just-culture-v919.js, mcp/adapters/just-culture-v919.js.
  { id: 'just-culture',       name: 'Just Culture behavior and response',               group: 'H', audiences: ['clinicians', 'educators'], clinical: false },
  ...
  { id: 'strongkids', name: 'STRONGkids (Pediatric Nutritional Risk Screen)', group: 'N', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'disability-rating-scale', name: 'Disability Rating Scale (DRS, Brain Injury)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'kyoto-gastritis', name: 'Kyoto Classification of Gastritis Score', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'msu-disc-herniation', name: 'MSU Classification (Lumbar Disc Herniation)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'kanavel-signs', name: 'Kanavel Signs (Flexor Tenosynovitis)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'hamada',                 name: 'Hamada Grade (Cuff Tear Arthropathy)',              group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'collin-rc', name: 'Collin Classification (Massive Rotator Cuff Tear)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'cognard-davf', name: 'Cognard Classification (Dural AV Fistula)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'robinson-clavicle', name: 'Robinson Classification (Clavicle Fractures)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'lateral-center-edge-angle', name: 'Lateral Center-Edge Angle of Wiberg (Hip Dysplasia)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'mrecist', name: 'mRECIST Response (Hepatocellular Carcinoma)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'cpak', name: 'CPAK Classification (Knee Alignment Phenotype)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'blackburne-peel', name: 'Blackburne-Peel Index (Patellar Height)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'pai-periapical', name: 'Periapical Index (PAI)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'jemt-papilla', name: 'Jemt Papilla Index (Implant)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'nordland-tarnow-papilla', name: 'Nordland-Tarnow Papilla Loss', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'peri-implant-status', name: 'Peri-Implant Case Definitions (2017)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'hamp-furcation', name: 'Hamp Furcation Degree', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'pufa-index', name: 'PUFA Index (Untreated Caries)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'bolton-ratio', name: 'Bolton Tooth-Size Ratio', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'eichner-index', name: 'Eichner Index (Occlusal Support)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'kotlow-ankyloglossia', name: 'Kotlow Ankyloglossia Class', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'ohat-oral-health', name: 'Oral Health Assessment Tool (OHAT)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'turesky-plaque', name: 'Turesky Plaque Index (TQHPI)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'veau-cleft', name: 'Veau Cleft Palate Class', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'essex-lopresti-calcaneal', name: 'Essex-Lopresti Calcaneal Fracture', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'paed-delirium', name: 'PAED Emergence Delirium Scale', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'watcha-emergence', name: 'Watcha Emergence Agitation Scale', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'glenoid-track', name: 'Glenoid Track (Hill-Sachs On/Off-Track)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'thomazeau-occupation', name: 'Thomazeau Occupation Ratio', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'periodontitis-stage-grade', name: 'Periodontitis Staging and Grading (2017 World Workshop)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'bpe-periodontal', name: 'Basic Periodontal Examination (BPE)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'ohi-s', name: 'Simplified Oral Hygiene Index (OHI-S)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'miller-gingival-recession', name: 'Miller Gingival Recession Class', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  { id: 'cairo-recession', name: 'Cairo Classification (Gingival Recession)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'asas-ibp', name: 'ASAS Inflammatory Back Pain Criteria', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  // spec-v908: whether a liver-injury lab set meets Hy's Law, and the potential-case
  ...
  // spec-v912: the NICHD three-tier fetal heart rate categories. Category II is a residual,
  ...
  // spec-v921: the sigma metric of a laboratory method. Every result names the goal the
  ...
  // spec-v923: analytical goals from biological variation. All three tiers print, because
  ...
  // spec-v958: the VExUS grade, where mild waveforms deliberately do not count and a dilated
  ...
  // spec-v1061: the Short Opiate Withdrawal Scale, the patient-reported sibling of COWS. Ten
  // symptoms, 0-3 each, and NO published severity bands -- the tile says so, because a reader who
  // has used COWS will expect four. views/group-v1061.js, lib/sows-v1061.js,
  // mcp/adapters/sows-v1061.js.
  { id: 'sows', name: 'SOWS (Short Opiate Withdrawal Scale)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },

  // spec-v1062: the OTHER SOWS -- Handelsman 1987's sixteen-item Subjective scale, which shares an
  // acronym with the Short scale above and is a different instrument. Both tiles say so.
  // views/group-v1062.js, lib/sows-subjective-v1062.js, mcp/adapters/sows-subjective-v1062.js.
  { id: 'sows-subjective', name: 'SOWS (Subjective Opiate Withdrawal Scale, Handelsman)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },

  // spec-v1240: four gallbladder and biliary grades that each get read wrongly in a specific place,
  // so each tile derives the grade from the findings rather than asking for it.
  // views/group-v1240.js, lib/parkland-gallbladder-v1240.js, lib/nassar-gallbladder-v1240.js,
  // lib/aast-cholecystitis-v1240.js, lib/csendes-mirizzi-v1240.js,
  // mcp/adapters/<id>-v1240.js, one per tile.
  { id: 'parkland-gallbladder', name: 'Parkland Grading Scale for Cholecystitis', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'hakki-valve-area', name: 'Hakki Valve Area (Simplified Gorlin)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'ng-tube-length', name: 'NG Tube Insertion Length (Corrected NEX)', group: 'E', audiences: ['clinicians', 'educators'], clinical: true },
  ...
  { id: 'hvpg', name: 'Hepatic Venous Pressure Gradient (HVPG)', group: 'G', audiences: ['clinicians', 'educators'], clinical: true },
...
const RETIRED_TILE_ALIASES = new Map([
  ...
  ['sort', 'sort-mortality'],
  // spec-v973: the four the CITATION signal found (spec-v972). None was reachable by name.
  ['qtc-suite', 'qtc'],
  ['kings-score', 'king-score'],
  ['four-ts', 'four-ts-hit'],
  ['bsa_burn', 'lund-browder'],
]);

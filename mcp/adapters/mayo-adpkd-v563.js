...
export default [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        label: 'Patient height in METRES (not cm). Required for class 1. The volume is divided by this to give the height-adjusted volume.',
      },
      {

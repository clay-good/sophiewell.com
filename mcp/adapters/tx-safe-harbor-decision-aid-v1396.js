...
export default [
  {
    ...
    summary: 'Explains how a Texas nurse requests Safe Harbor peer review under Occupations Code 303.005, and what it protects. Use the Board form, or tell the supervisor orally when patient care prevents it; the supervisor records seven items and both sign. A good-faith request cannot be punished, and a physician order\'s medical reasonableness goes to the medical staff. Board rule 22 TAC 217.20 adds the deadlines: the comprehensive written request before leaving at the end of the shift, the committee decision within 14 days, and the CNO\'s notice within 48 hours.',

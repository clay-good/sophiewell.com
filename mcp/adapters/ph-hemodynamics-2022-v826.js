...
export default [
  {
    ...
    summary: 'Classifies right heart catheterization numbers under the 2022 ESC/ERS definitions. PH is mPAP above 20 mmHg; pre-capillary adds PAWP at or below 15 with PVR above 2 Wood units; a PAWP above 15 gives isolated post-capillary (PVR at or below 2) or combined (PVR above 2). BOTH thresholds fell in 2022, from 25 mmHg and 3 WU, so older figures under-call. PVR is computed from cardiac output when not supplied.',

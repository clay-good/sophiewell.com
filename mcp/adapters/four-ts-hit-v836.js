...
export default [
  {
    ...
    compute: fourTsHit,
    fields: [
      { dom: 'fts-thrombocytopenia', arg: 'thrombocytopenia', kind: 'number', required: true, values: ['0', '1', '2'], label: 'Thrombocytopenia, 0 to 2' },
      { dom: 'fts-timing', arg: 'timing', kind: 'number', required: true, values: ['0', '1', '2'], label: 'Timing of the platelet fall, 0 to 2' },
      { dom: 'fts-thrombosis', arg: 'thrombosis', kind: 'number', required: true, values: ['0', '1', '2'], label: 'Thrombosis or other sequelae, 0 to 2' },
      { dom: 'fts-other', arg: 'otherCauses', kind: 'number', required: true, values: ['0', '1', '2'], label: 'Other causes of thrombocytopenia, 0 to 2' },

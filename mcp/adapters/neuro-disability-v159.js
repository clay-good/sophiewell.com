...
export default [
  ...
  },
  {
    ...
    fields: [
      ...
      { dom: 'edss-pyramidal', arg: 'pyramidal', kind: 'number', label: 'Pyramidal FS (0–6)', values: ['0', '1', '2', '3', '4', '5', '6'] },
      { dom: 'edss-cerebellar', arg: 'cerebellar', kind: 'number', label: 'Cerebellar FS (0–5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'edss-brainstem', arg: 'brainstem', kind: 'number', label: 'Brainstem FS (0–5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'edss-sensory', arg: 'sensory', kind: 'number', label: 'Sensory FS (0–6)', values: ['0', '1', '2', '3', '4', '5', '6'] },
      { dom: 'edss-bowelBladder', arg: 'bowelBladder', kind: 'number', label: 'Bowel & bladder FS (0–6)', values: ['0', '1', '2', '3', '4', '5', '6'] },
      { dom: 'edss-visual', arg: 'visual', kind: 'number', label: 'Visual FS (0–6)', values: ['0', '1', '2', '3', '4', '5', '6'] },
      { dom: 'edss-cerebral', arg: 'cerebral', kind: 'number', label: 'Cerebral FS (0–5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'edss-other', arg: 'other', kind: 'number', label: 'Other FS (0–1)', values: ['0', '1'] },
    ],
  },
];

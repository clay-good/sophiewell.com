...
export default [
  ...
  },
  {
    ...
    compute: F.uceis,
    fields: [
      { dom: 'uc-vasc', arg: 'vascular', kind: 'number', required: true, label: 'Vascular pattern (0 normal, 1 patchy, 2 obliterated)', values: ['0', '1', '2'] },
      { dom: 'uc-bleed', arg: 'bleeding', kind: 'number', required: true, label: 'Bleeding (0 none … 3 luminal moderate/severe)', values: ['0', '1', '2', '3'] },
      { dom: 'uc-ero', arg: 'erosions', kind: 'number', required: true, label: 'Erosions/ulcers (0 none … 3 deep ulcer)', values: ['0', '1', '2', '3'] },
    ],
  },
  {
    id: 'haps',
  ...
  },
  {
    ...
    fields: [
      { dom: 'ct-grade', arg: 'grade', kind: 'number', required: true, label: 'Balthazar CT grade (A=0 … E=4)', values: ['0', '1', '2', '3', '4'] },
      { dom: 'ct-necr', arg: 'necrosis', kind: 'number', required: true, label: 'Pancreatic necrosis (0 none, 2 ≤ 30%, 4 30-50%, 6 > 50%)', values: ['0', '2', '4', '6'] },
    ],
  },
  {
    ...
    fields: [
      ...
      { dom: 'mm-cv', arg: 'cardiovascular', kind: 'number', label: 'Cardiovascular score (0-4, pre-banded; blank = not assessed)', values: ['0', '1', '2', '3', '4'] },
    ],
  },
  {
    id: 'ses-cd',

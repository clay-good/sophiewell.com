...
export default [
  ...
  },
  {
    ...
    compute: F.rdaiTal,
    fields: [
      { dom: 'rd-wexp', arg: 'wheezeExp', kind: 'number', label: 'RDAI: expiratory wheeze (0–4)', values: ['0', '1', '2', '3', '4'] },
      { dom: 'rd-winsp', arg: 'wheezeInsp', kind: 'number', label: 'RDAI: inspiratory wheeze (0–2)', values: ['0', '1', '2'] },
      { dom: 'rd-wloc', arg: 'wheezeLoc', kind: 'number', label: 'RDAI: wheeze location (0–2)', values: ['0', '1', '2'] },
      { dom: 'rd-supra', arg: 'retSupraclav', kind: 'number', label: 'RDAI: supraclavicular retractions (0–3)', values: ['0', '1', '2', '3'] },
      { dom: 'rd-inter', arg: 'retIntercostal', kind: 'number', label: 'RDAI: intercostal retractions (0–3)', values: ['0', '1', '2', '3'] },
      { dom: 'rd-sub', arg: 'retSubcostal', kind: 'number', label: 'RDAI: subcostal retractions (0–3)', values: ['0', '1', '2', '3'] },
      { dom: 'rd-trr', arg: 'talRr', kind: 'number', label: 'Tal: respiratory rate (0–3)', values: ['0', '1', '2', '3'] },
      { dom: 'rd-twhz', arg: 'talWheeze', kind: 'number', label: 'Tal: wheeze (0–3)', values: ['0', '1', '2', '3'] },
      { dom: 'rd-tcyan', arg: 'talCyanosis', kind: 'number', label: 'Tal: cyanosis (0–3)', values: ['0', '1', '2', '3'] },
      { dom: 'rd-tacc', arg: 'talAccessory', kind: 'number', label: 'Tal: accessory muscle use (0–3)', values: ['0', '1', '2', '3'] },
    ],
  },
  {
    ...
    fields: [
      { dom: 'cd-app', arg: 'appearance', kind: 'number', label: 'General appearance (0–2)', values: ['0', '1', '2'] },
      { dom: 'cd-eyes', arg: 'eyes', kind: 'number', label: 'Eyes (0–2)', values: ['0', '1', '2'] },
      { dom: 'cd-muc', arg: 'mucous', kind: 'number', label: 'Mucous membranes (0–2)', values: ['0', '1', '2'] },
      { dom: 'cd-tears', arg: 'tears', kind: 'number', label: 'Tears (0–2)', values: ['0', '1', '2'] },
    ],
  },
  {

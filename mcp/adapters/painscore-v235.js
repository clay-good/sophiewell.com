...
export default [
  ...
  },
  {
    ...
    fields: [
      { dom: 'ndi-pain', arg: 'pain', kind: 'number', required: true, label: 'Pain intensity (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'ndi-care', arg: 'care', kind: 'number', required: true, label: 'Personal care (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'ndi-lift', arg: 'lifting', kind: 'number', required: true, label: 'Lifting (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'ndi-read', arg: 'reading', kind: 'number', required: true, label: 'Reading (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'ndi-head', arg: 'headaches', kind: 'number', required: true, label: 'Headaches (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'ndi-conc', arg: 'concentration', kind: 'number', required: true, label: 'Concentration (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'ndi-work', arg: 'work', kind: 'number', required: true, label: 'Work (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'ndi-drive', arg: 'driving', kind: 'number', required: true, label: 'Driving (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'ndi-sleep', arg: 'sleeping', kind: 'number', required: true, label: 'Sleeping (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'ndi-rec', arg: 'recreation', kind: 'number', required: true, label: 'Recreation (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
    ],
  },
];

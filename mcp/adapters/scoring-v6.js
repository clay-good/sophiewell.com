...
export default [
  ...
  },
  {
    ...
    fields: [
      ...
      { dom: 'ps-vaso', arg: 'vasoactive', kind: 'number', label: 'Vasoactive grade (0-4)', values: ['0', '1', '2', '3', '4'] },
  ...
  },
  {
    ...
    fields: [
      { dom: 'bw-temp', arg: 'temp', kind: 'number', required: true, label: 'Temperature points (0-30)', values: ['0', '5', '10', '15', '20', '25', '30'] },
      { dom: 'bw-cns', arg: 'cns', kind: 'number', required: true, label: 'CNS effects points (0-30)', values: ['0', '10', '20', '30'] },
      { dom: 'bw-gi', arg: 'gi', kind: 'number', required: true, label: 'GI-hepatic points (0-20)', values: ['0', '10', '20'] },
      { dom: 'bw-hr', arg: 'hr', kind: 'number', required: true, label: 'Tachycardia points (0-25)', values: ['0', '5', '10', '15', '20', '25'] },
      { dom: 'bw-chf', arg: 'chf', kind: 'number', required: true, label: 'Congestive heart failure points (0-15)', values: ['0', '5', '10', '15'] },
  ...
  },
  {
    ...
    compute: F.ariscat,
    fields: [
      { dom: 'ar-age', arg: 'agePts', kind: 'number', required: true, label: 'Age points (0/3/16)', values: ['0', '3', '16'] },
      { dom: 'ar-spo2', arg: 'spo2Pts', kind: 'number', required: true, label: 'Preoperative SpO2 points (0/8/24)', values: ['0', '8', '24'] },
      { dom: 'ar-incision', arg: 'incisionPts', kind: 'number', required: true, label: 'Surgical incision points (0/15/24)', values: ['0', '15', '24'] },
      { dom: 'ar-duration', arg: 'durationPts', kind: 'number', required: true, label: 'Surgery duration points (0/16/23)', values: ['0', '16', '23'] },
  ...
  },
  {
    ...
    compute: F.bradenQ,
    fields: [
      { dom: 'bq-mobility', arg: 'mobility', kind: 'number', required: true, label: 'Mobility (1-4)', values: ['1', '2', '3', '4'] },
      { dom: 'bq-activity', arg: 'activity', kind: 'number', required: true, label: 'Activity (1-4)', values: ['1', '2', '3', '4'] },
      { dom: 'bq-sensory', arg: 'sensory', kind: 'number', required: true, label: 'Sensory perception (1-4)', values: ['1', '2', '3', '4'] },
      { dom: 'bq-moisture', arg: 'moisture', kind: 'number', required: true, label: 'Moisture (1-4)', values: ['1', '2', '3', '4'] },
      { dom: 'bq-friction', arg: 'friction', kind: 'number', required: true, label: 'Friction / shear (1-4)', values: ['1', '2', '3', '4'] },
      { dom: 'bq-nutrition', arg: 'nutrition', kind: 'number', required: true, label: 'Nutrition (1-4)', values: ['1', '2', '3', '4'] },
      { dom: 'bq-perfusion', arg: 'perfusion', kind: 'number', required: true, label: 'Tissue perfusion / oxygenation (1-4)', values: ['1', '2', '3', '4'] },
    ],
  },
];

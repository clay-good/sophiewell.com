...
export default [
  {
    ...
    compute: nenWhoGrade,
    fields: [
      // spec-v1138: required. Well and poor are two entities, not two grades, and the
      // library no longer assumes one.
      { dom: 'nen-diff', arg: 'differentiation', kind: 'enum', values: ['well', 'poor'], required: true, label: 'Differentiation' },

...
export default [
  ...
  },
  {
    ...
    compute: F.poem,
    fields: [
      { dom: 'poem-itch', arg: 'itch', kind: 'number', required: true, label: 'Itch (0–4)', values: ['0', '1', '2', '3', '4'] },
      { dom: 'poem-sleep', arg: 'sleep', kind: 'number', required: true, label: 'Sleep disturbance (0–4)', values: ['0', '1', '2', '3', '4'] },
      { dom: 'poem-bleed', arg: 'bleeding', kind: 'number', required: true, label: 'Bleeding (0–4)', values: ['0', '1', '2', '3', '4'] },
      { dom: 'poem-weep', arg: 'weeping', kind: 'number', required: true, label: 'Weeping / oozing (0–4)', values: ['0', '1', '2', '3', '4'] },
      { dom: 'poem-crack', arg: 'cracking', kind: 'number', required: true, label: 'Cracking (0–4)', values: ['0', '1', '2', '3', '4'] },
      { dom: 'poem-flake', arg: 'flaking', kind: 'number', required: true, label: 'Flaking (0–4)', values: ['0', '1', '2', '3', '4'] },
      { dom: 'poem-dry', arg: 'dryness', kind: 'number', required: true, label: 'Dryness / roughness (0–4)', values: ['0', '1', '2', '3', '4'] },
    ],
  },
  {
    id: 'alden',

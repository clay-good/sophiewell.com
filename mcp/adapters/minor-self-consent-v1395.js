...
export default [
  {
    ...
    summary: "Whether a minor may consent alone to a service in NY, NJ, CA, or TX, and under which section. California's Family Code lets a minor consent to pregnancy prevention and care at any age (6925), and from 12 to STI and reportable-disease care (6926), care after rape (6927), outpatient mental health if mature enough (6924), and substance use treatment (6929), and from 15 if living apart and self-supporting (6922). Texas Family Code 32.003 lets a child consent when on active duty, at 16 if living apart and self-supporting, for reportable infectious disease, for pregnancy care other than abortion, and for drug or chemical dependency. New York (PHL 2504, 2305; MHL 33.21, 22.11) and New Jersey (9:17A-1, 9:17A-4) are covered too; what no statute read settles is left unanswered.",

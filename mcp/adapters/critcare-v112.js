...
export default [
  ...
  },
  {
    ...
    fields: [
      { dom: 'mr-shl', arg: 'shoulderL', kind: 'number', required: true, label: 'Shoulder abduction, left (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'mr-shr', arg: 'shoulderR', kind: 'number', required: true, label: 'Shoulder abduction, right (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'mr-ell', arg: 'elbowL', kind: 'number', required: true, label: 'Elbow flexion, left (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'mr-elr', arg: 'elbowR', kind: 'number', required: true, label: 'Elbow flexion, right (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'mr-wrl', arg: 'wristL', kind: 'number', required: true, label: 'Wrist extension, left (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'mr-wrr', arg: 'wristR', kind: 'number', required: true, label: 'Wrist extension, right (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'mr-hil', arg: 'hipL', kind: 'number', required: true, label: 'Hip flexion, left (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'mr-hir', arg: 'hipR', kind: 'number', required: true, label: 'Hip flexion, right (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'mr-knl', arg: 'kneeL', kind: 'number', required: true, label: 'Knee extension, left (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'mr-knr', arg: 'kneeR', kind: 'number', required: true, label: 'Knee extension, right (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'mr-anl', arg: 'ankleL', kind: 'number', required: true, label: 'Ankle dorsiflexion, left (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
      { dom: 'mr-anr', arg: 'ankleR', kind: 'number', required: true, label: 'Ankle dorsiflexion, right (0-5)', values: ['0', '1', '2', '3', '4', '5'] },
    ],
  },
];

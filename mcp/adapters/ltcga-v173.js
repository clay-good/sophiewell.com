...
export default [
  {
    ...
    compute: F.bims,
    fields: [
    { dom: 'bims-rep', arg: 'repetition', kind: 'number', required: true, label: 'Repetition', values: ['0', '1', '2', '3'] },
    { dom: 'bims-year', arg: 'year', kind: 'number', required: true, label: 'Year', values: ['0', '1', '2', '3'] },
    { dom: 'bims-month', arg: 'month', kind: 'number', required: true, label: 'Month', values: ['0', '1', '2'] },
    { dom: 'bims-day', arg: 'day', kind: 'number', required: true, label: 'Day', values: ['0', '1'] },
    { dom: 'bims-sock', arg: 'recallSock', kind: 'number', required: true, label: 'Recall Sock', values: ['0', '1', '2'] },
    { dom: 'bims-blue', arg: 'recallBlue', kind: 'number', required: true, label: 'Recall Blue', values: ['0', '1', '2'] },
    { dom: 'bims-bed', arg: 'recallBed', kind: 'number', required: true, label: 'Recall Bed', values: ['0', '1', '2'] },
    ],
  },
  {
    id: 'ad8',
  ...
  },
  {
    ...
    compute: F.cdrSob,
    fields: [
    { dom: 'cdr-memory', arg: 'memory', kind: 'number', required: true, label: 'Memory', values: ['0', '0.5', '1', '2', '3'] },
    { dom: 'cdr-orientation', arg: 'orientation', kind: 'number', required: true, label: 'Orientation', values: ['0', '0.5', '1', '2', '3'] },
    { dom: 'cdr-judgment', arg: 'judgment', kind: 'number', required: true, label: 'Judgment', values: ['0', '0.5', '1', '2', '3'] },
    { dom: 'cdr-community', arg: 'community', kind: 'number', required: true, label: 'Community', values: ['0', '0.5', '1', '2', '3'] },
    { dom: 'cdr-home', arg: 'home', kind: 'number', required: true, label: 'Home', values: ['0', '0.5', '1', '2', '3'] },
    { dom: 'cdr-personalCare', arg: 'personalCare', kind: 'number', required: true, label: 'Personal Care', values: ['0', '1', '2', '3'] },
    ],
  },
];

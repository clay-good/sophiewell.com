...
export default [
  {
    ...
    compute: W.wexner,
    fields: [
      { dom: 'wex-solid', arg: 'solid', kind: 'number', required: true, label: 'Incontinence to solid stool (0-4)', values: ['0', '1', '2', '3', '4'] },
      { dom: 'wex-liquid', arg: 'liquid', kind: 'number', required: true, label: 'Incontinence to liquid stool (0-4)', values: ['0', '1', '2', '3', '4'] },
      { dom: 'wex-gas', arg: 'gas', kind: 'number', required: true, label: 'Incontinence to gas (0-4)', values: ['0', '1', '2', '3', '4'] },
      { dom: 'wex-pad', arg: 'pad', kind: 'number', required: true, label: 'Wears a pad (0-4)', values: ['0', '1', '2', '3', '4'] },
      { dom: 'wex-lifestyle', arg: 'lifestyle', kind: 'number', required: true, label: 'Lifestyle alteration (0-4)', values: ['0', '1', '2', '3', '4'] },
    ],
  },
];

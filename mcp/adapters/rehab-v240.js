...
export default [
  ...
  },
  {
    ...
    compute: F.quickDash,
    fields: [
      { dom: 'qd-1', arg: 'i1', kind: 'number', required: true, label: '1. Open a tight jar (1-5)', values: ['1', '2', '3', '4', '5'] },
      { dom: 'qd-2', arg: 'i2', kind: 'number', required: true, label: '2. Heavy household chores (1-5)', values: ['1', '2', '3', '4', '5'] },
      { dom: 'qd-3', arg: 'i3', kind: 'number', required: true, label: '3. Carry a shopping bag (1-5)', values: ['1', '2', '3', '4', '5'] },
      { dom: 'qd-4', arg: 'i4', kind: 'number', required: true, label: '4. Wash your back (1-5)', values: ['1', '2', '3', '4', '5'] },
      { dom: 'qd-5', arg: 'i5', kind: 'number', required: true, label: '5. Use a knife (1-5)', values: ['1', '2', '3', '4', '5'] },
      { dom: 'qd-6', arg: 'i6', kind: 'number', required: true, label: '6. Recreational activities (1-5)', values: ['1', '2', '3', '4', '5'] },
      { dom: 'qd-7', arg: 'i7', kind: 'number', required: true, label: '7. Social activities limited (1-5)', values: ['1', '2', '3', '4', '5'] },
      { dom: 'qd-8', arg: 'i8', kind: 'number', required: true, label: '8. Work / daily activities limited (1-5)', values: ['1', '2', '3', '4', '5'] },
      { dom: 'qd-9', arg: 'i9', kind: 'number', required: true, label: '9. Arm/shoulder/hand pain (1-5)', values: ['1', '2', '3', '4', '5'] },
      { dom: 'qd-10', arg: 'i10', kind: 'number', required: true, label: '10. Tingling (1-5)', values: ['1', '2', '3', '4', '5'] },
      { dom: 'qd-11', arg: 'i11', kind: 'number', required: true, label: '11. Difficulty sleeping (1-5)', values: ['1', '2', '3', '4', '5'] },
    ],
  },
];

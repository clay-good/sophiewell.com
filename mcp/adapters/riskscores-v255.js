...
export default [
  {
    ...
    compute: F.vcss,
    fields: [
      { dom: 'vc-pain', arg: 'pain', kind: 'number', required: true, label: 'Pain (0-3)', values: ['0', '1', '2', '3'] },
      { dom: 'vc-var', arg: 'varicose', kind: 'number', required: true, label: 'Varicose veins (0-3)', values: ['0', '1', '2', '3'] },
      { dom: 'vc-edema', arg: 'edema', kind: 'number', required: true, label: 'Venous edema (0-3)', values: ['0', '1', '2', '3'] },
      { dom: 'vc-pig', arg: 'pigmentation', kind: 'number', required: true, label: 'Skin pigmentation (0-3)', values: ['0', '1', '2', '3'] },
      { dom: 'vc-inf', arg: 'inflammation', kind: 'number', required: true, label: 'Inflammation (0-3)', values: ['0', '1', '2', '3'] },
      { dom: 'vc-ind', arg: 'induration', kind: 'number', required: false, label: 'Induration (0-3)', values: ['0', '1', '2', '3'] },
      { dom: 'vc-uln', arg: 'ulcerNumber', kind: 'number', required: false, label: 'Number of active ulcers (0-3)', values: ['0', '1', '2', '3'] },
      { dom: 'vc-uld', arg: 'ulcerDuration', kind: 'number', required: false, label: 'Active ulcer duration (0-3)', values: ['0', '1', '2', '3'] },
      { dom: 'vc-uls', arg: 'ulcerSize', kind: 'number', required: false, label: 'Active ulcer size (0-3)', values: ['0', '1', '2', '3'] },
      { dom: 'vc-comp', arg: 'compression', kind: 'number', required: false, label: 'Use of compression therapy (0-3)', values: ['0', '1', '2', '3'] },
    ],
  },
  {
    id: 'pen-fast',

...
export default [
  ...
  },
  {
    ...
    fields: [
      ...
      { dom: 'gu-ssSw', arg: 'semisolidSwallow', kind: 'number', required: false, label: 'Semisolid deglutition (0-2)' },
      { dom: 'gu-ssCg', arg: 'semisolidNoCough', kind: 'number', required: false, label: 'Semisolid: no involuntary cough (0-1)' },
      { dom: 'gu-ssDr', arg: 'semisolidNoDrool', kind: 'number', required: false, label: 'Semisolid: no drooling (0-1)' },
      { dom: 'gu-ssVc', arg: 'semisolidNoVoiceChange', kind: 'number', required: false, label: 'Semisolid: no voice change (0-1)' },
      { dom: 'gu-liSw', arg: 'liquidSwallow', kind: 'number', required: false, label: 'Liquid deglutition (0-2)' },
      { dom: 'gu-liCg', arg: 'liquidNoCough', kind: 'number', required: false, label: 'Liquid: no involuntary cough (0-1)' },
      { dom: 'gu-liDr', arg: 'liquidNoDrool', kind: 'number', required: false, label: 'Liquid: no drooling (0-1)' },
      { dom: 'gu-liVc', arg: 'liquidNoVoiceChange', kind: 'number', required: false, label: 'Liquid: no voice change (0-1)' },
      { dom: 'gu-soSw', arg: 'solidSwallow', kind: 'number', required: false, label: 'Solid deglutition (0-2)' },
      { dom: 'gu-soCg', arg: 'solidNoCough', kind: 'number', required: false, label: 'Solid: no involuntary cough (0-1)' },
      { dom: 'gu-soDr', arg: 'solidNoDrool', kind: 'number', required: false, label: 'Solid: no drooling (0-1)' },
      { dom: 'gu-soVc', arg: 'solidNoVoiceChange', kind: 'number', required: false, label: 'Solid: no voice change (0-1)' },
    ],
  },
  {
    id: 'barthel',
    ...
    compute: F.barthel,
    fields: [
      { dom: 'bt-feed', arg: 'feeding', kind: 'number', required: true, label: 'Feeding (0/5/10)', values: ['0', '5', '10'] },
      { dom: 'bt-bath', arg: 'bathing', kind: 'number', required: true, label: 'Bathing (0/5)', values: ['0', '5'] },
      { dom: 'bt-groom', arg: 'grooming', kind: 'number', required: true, label: 'Grooming (0/5)', values: ['0', '5'] },
      { dom: 'bt-dress', arg: 'dressing', kind: 'number', required: true, label: 'Dressing (0/5/10)', values: ['0', '5', '10'] },
      { dom: 'bt-bowel', arg: 'bowel', kind: 'number', required: true, label: 'Bowel control (0/5/10)', values: ['0', '5', '10'] },
      { dom: 'bt-bladder', arg: 'bladder', kind: 'number', required: true, label: 'Bladder control (0/5/10)', values: ['0', '5', '10'] },
      { dom: 'bt-toil', arg: 'toilet', kind: 'number', required: true, label: 'Toilet use (0/5/10)', values: ['0', '5', '10'] },
      { dom: 'bt-trans', arg: 'transfers', kind: 'number', required: true, label: 'Transfers (0/5/10/15)', values: ['0', '5', '10', '15'] },
      { dom: 'bt-mob', arg: 'mobility', kind: 'number', required: true, label: 'Mobility (0/5/10/15)', values: ['0', '5', '10', '15'] },
      { dom: 'bt-stair', arg: 'stairs', kind: 'number', required: true, label: 'Stairs (0/5/10)', values: ['0', '5', '10'] },
    ],
  },
  {
    id: 'lawton-iadl',
    ...
    fields: [
      { dom: 'lw-tel', arg: 'telephone', kind: 'number', required: true, values: ['0', '1'], label: 'Telephone use (0/1)' },
      { dom: 'lw-shop', arg: 'shopping', kind: 'number', required: true, values: ['0', '1'], label: 'Shopping (0/1)' },
      { dom: 'lw-food', arg: 'foodPrep', kind: 'number', required: true, values: ['0', '1'], label: 'Food preparation (0/1)' },
      { dom: 'lw-house', arg: 'housekeeping', kind: 'number', required: true, values: ['0', '1'], label: 'Housekeeping (0/1)' },
      { dom: 'lw-laund', arg: 'laundry', kind: 'number', required: true, values: ['0', '1'], label: 'Laundry (0/1)' },
      { dom: 'lw-trans', arg: 'transportation', kind: 'number', required: true, values: ['0', '1'], label: 'Transportation (0/1)' },
      { dom: 'lw-med', arg: 'medications', kind: 'number', required: true, values: ['0', '1'], label: 'Medication responsibility (0/1)' },
      { dom: 'lw-fin', arg: 'finances', kind: 'number', required: true, values: ['0', '1'], label: 'Handling finances (0/1)' },
    ],
  },
  {
    id: 'katz-adl',
    ...
    compute: F.katzAdl,
    fields: [
      { dom: 'kz-bath', arg: 'bathing', kind: 'number', required: true, values: ['0', '1'], label: 'Bathing (0/1)' },
      { dom: 'kz-dress', arg: 'dressing', kind: 'number', required: true, values: ['0', '1'], label: 'Dressing (0/1)' },
      { dom: 'kz-toil', arg: 'toileting', kind: 'number', required: true, values: ['0', '1'], label: 'Toileting (0/1)' },
      { dom: 'kz-trans', arg: 'transferring', kind: 'number', required: true, values: ['0', '1'], label: 'Transferring (0/1)' },
      { dom: 'kz-cont', arg: 'continence', kind: 'number', required: true, values: ['0', '1'], label: 'Continence (0/1)' },
      { dom: 'kz-feed', arg: 'feeding', kind: 'number', required: true, values: ['0', '1'], label: 'Feeding (0/1)' },
    ],
  },
  {
    id: 'cssrs',

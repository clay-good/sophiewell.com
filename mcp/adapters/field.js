...
// (data-driven, not a fixed field list), and the airway / drug-dose tiles
// (burn-fluid, peds-ett, naloxone, peds-weight-dose) take array inputs or
// recipe-table lookups that need a bespoke toArgs.

...
export default [
  ...
  },
  {
    ...
    compute: F.snaq,
    fields: [
    { dom: 'snaq-appetite', arg: 'appetite', kind: 'number', required: true, label: 'Appetite', values: ['1', '2', '3', '4', '5'] },
    { dom: 'snaq-fullness', arg: 'fullness', kind: 'number', required: true, label: 'Fullness', values: ['1', '2', '3', '4', '5'] },
    { dom: 'snaq-taste', arg: 'taste', kind: 'number', required: true, label: 'Taste', values: ['1', '2', '3', '4', '5'] },
    { dom: 'snaq-meals', arg: 'meals', kind: 'number', required: true, label: 'Meals', values: ['1', '2', '3', '4', '5'] },
    ],
  },
  {
    id: 'eat-10',
    ...
    compute: F.eat10,
    fields: [
    { dom: 'eat-1', arg: 'i1', kind: 'number', required: true, label: 'I1', values: ['0', '1', '2', '3', '4'] },
    { dom: 'eat-2', arg: 'i2', kind: 'number', required: true, label: 'I2', values: ['0', '1', '2', '3', '4'] },
    { dom: 'eat-3', arg: 'i3', kind: 'number', required: true, label: 'I3', values: ['0', '1', '2', '3', '4'] },
    { dom: 'eat-4', arg: 'i4', kind: 'number', required: true, label: 'I4', values: ['0', '1', '2', '3', '4'] },
    { dom: 'eat-5', arg: 'i5', kind: 'number', required: true, label: 'I5', values: ['0', '1', '2', '3', '4'] },
    { dom: 'eat-6', arg: 'i6', kind: 'number', required: true, label: 'I6', values: ['0', '1', '2', '3', '4'] },
    { dom: 'eat-7', arg: 'i7', kind: 'number', required: true, label: 'I7', values: ['0', '1', '2', '3', '4'] },
    { dom: 'eat-8', arg: 'i8', kind: 'number', required: true, label: 'I8', values: ['0', '1', '2', '3', '4'] },
    { dom: 'eat-9', arg: 'i9', kind: 'number', required: true, label: 'I9', values: ['0', '1', '2', '3', '4'] },
    { dom: 'eat-10', arg: 'i10', kind: 'number', required: true, label: 'I10', values: ['0', '1', '2', '3', '4'] },
    ],
  },
  {
    id: 'determine',

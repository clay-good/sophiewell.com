...
export default [
  {
    ...
    fields: [
    { dom: 'sandvik-freq', arg: 'frequency', kind: 'number', required: true, label: 'Frequency', values: ['1', '2', '3', '4'] },
    { dom: 'sandvik-amount', arg: 'amount', kind: 'number', required: true, label: 'Amount', values: ['1', '2', '3'] },
    ],
  },
  {
    id: 'iciq-ui-sf',
  ...
  },
  {
    ...
    fields: [
    { dom: 'mcsi-sleep', arg: 'sleep', kind: 'number', required: true, label: 'Sleep', values: ['0', '1', '2'] },
    { dom: 'mcsi-physical', arg: 'physical', kind: 'number', required: true, label: 'Physical', values: ['0', '1', '2'] },
    { dom: 'mcsi-confining', arg: 'confining', kind: 'number', required: true, label: 'Confining', values: ['0', '1', '2'] },
    { dom: 'mcsi-family', arg: 'family', kind: 'number', required: true, label: 'Family', values: ['0', '1', '2'] },
    { dom: 'mcsi-plans', arg: 'plans', kind: 'number', required: true, label: 'Plans', values: ['0', '1', '2'] },
    { dom: 'mcsi-other', arg: 'otherDemands', kind: 'number', required: true, label: 'Other Demands', values: ['0', '1', '2'] },
    { dom: 'mcsi-emotional', arg: 'emotional', kind: 'number', required: true, label: 'Emotional', values: ['0', '1', '2'] },
    { dom: 'mcsi-upsetting', arg: 'upsetting', kind: 'number', required: true, label: 'Upsetting', values: ['0', '1', '2'] },
    { dom: 'mcsi-changed', arg: 'changed', kind: 'number', required: true, label: 'Changed', values: ['0', '1', '2'] },
    { dom: 'mcsi-work', arg: 'work', kind: 'number', required: true, label: 'Work', values: ['0', '1', '2'] },
    { dom: 'mcsi-financial', arg: 'financial', kind: 'number', required: true, label: 'Financial', values: ['0', '1', '2'] },
    { dom: 'mcsi-overwhelmed', arg: 'overwhelmed', kind: 'number', required: true, label: 'Overwhelmed', values: ['0', '1', '2'] },
    { dom: 'mcsi-completely', arg: 'completelyOverwhelmed', kind: 'number', required: true, label: 'Completely Overwhelmed', values: ['0', '1', '2'] },
    ],
  },
  {
  ...
  },
  {
    ...
    compute: F.bwat,
    fields: [
    { dom: 'bwat-size', arg: 'size', kind: 'number', required: true, label: 'Size', values: ['1', '2', '3', '4', '5'] },
    { dom: 'bwat-depth', arg: 'depth', kind: 'number', required: true, label: 'Depth', values: ['1', '2', '3', '4', '5'] },
    { dom: 'bwat-edges', arg: 'edges', kind: 'number', required: true, label: 'Edges', values: ['1', '2', '3', '4', '5'] },
    { dom: 'bwat-undermining', arg: 'undermining', kind: 'number', required: true, label: 'Undermining', values: ['1', '2', '3', '4', '5'] },
    { dom: 'bwat-nectype', arg: 'necroticType', kind: 'number', required: true, label: 'Necrotic Type', values: ['1', '2', '3', '4', '5'] },
    { dom: 'bwat-necamount', arg: 'necroticAmount', kind: 'number', required: true, label: 'Necrotic Amount', values: ['1', '2', '3', '4', '5'] },
    { dom: 'bwat-exutype', arg: 'exudateType', kind: 'number', required: true, label: 'Exudate Type', values: ['1', '2', '3', '4', '5'] },
    { dom: 'bwat-exuamount', arg: 'exudateAmount', kind: 'number', required: true, label: 'Exudate Amount', values: ['1', '2', '3', '4', '5'] },
    { dom: 'bwat-skin', arg: 'skinColor', kind: 'number', required: true, label: 'Skin Color', values: ['1', '2', '3', '4', '5'] },
    { dom: 'bwat-edema', arg: 'edema', kind: 'number', required: true, label: 'Edema', values: ['1', '2', '3', '4', '5'] },
    { dom: 'bwat-induration', arg: 'induration', kind: 'number', required: true, label: 'Induration', values: ['1', '2', '3', '4', '5'] },
    { dom: 'bwat-granulation', arg: 'granulation', kind: 'number', required: true, label: 'Granulation', values: ['1', '2', '3', '4', '5'] },
    { dom: 'bwat-epithelialization', arg: 'epithelialization', kind: 'number', required: true, label: 'Epithelialization', values: ['1', '2', '3', '4', '5'] },
    ],
  },
];

...
export default [
  {
    ...
    compute: F.sarcF,
    fields: [
    { dom: 'sarcf-strength', arg: 'strength', kind: 'number', required: true, label: 'Strength', values: ['0', '1', '2'] },
    { dom: 'sarcf-walk', arg: 'assistanceWalking', kind: 'number', required: true, label: 'Assistance Walking', values: ['0', '1', '2'] },
    { dom: 'sarcf-rise', arg: 'riseFromChair', kind: 'number', required: true, label: 'Rise From Chair', values: ['0', '1', '2'] },
    { dom: 'sarcf-stairs', arg: 'climbStairs', kind: 'number', required: true, label: 'Climb Stairs', values: ['0', '1', '2'] },
    { dom: 'sarcf-falls', arg: 'falls', kind: 'number', required: true, label: 'Falls', values: ['0', '1', '2'] },
    ],
  },
  {
    id: 'sarc-calf',

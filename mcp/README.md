...
list_calculators { "specialty": "hepatology" }
  -> { coverage: "1205 of 1109 catalog tiles exposed ...", calculators: [ { id: "meld-xi", ... }, ... ] }
...
fracture) in `lib/russe-scaphoid-v416.js`, for 1205 across 321 modules today. <!-- catalog-truth:historical (197 is the count of lib modules adapted, not a catalog tile count) -->

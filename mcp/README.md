...
list_calculators { "specialty": "hepatology" }
  -> { coverage: "1232 of 1109 catalog tiles exposed ...", calculators: [ { id: "meld-xi", ... }, ... ] }
...
classification (cerebral cavernous malformation) in `lib/zabramski-v442.js`, and a two-hundred-sixty-eighth
the Kadish staging (esthesioneuroblastoma) in `lib/kadish-v443.js`, for 1232 across 348 modules today. <!-- catalog-truth:historical (197 is the count of lib modules adapted, not a catalog tile count) -->

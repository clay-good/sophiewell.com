...
list_calculators { "specialty": "hepatology" }
  -> { coverage: "1221 of 1109 catalog tiles exposed ...", calculators: [ { id: "meld-xi", ... }, ... ] }
...
`lib/bell-nec-v431.js`, and a two-hundred-fifty-seventh the Baden-Walker prolapse grade in
`lib/baden-walker-v432.js`, for 1221 across 337 modules today. <!-- catalog-truth:historical (197 is the count of lib modules adapted, not a catalog tile count) -->

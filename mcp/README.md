...
list_calculators { "specialty": "hepatology" }
  -> { coverage: "1229 of 1109 catalog tiles exposed ...", calculators: [ { id: "meld-xi", ... }, ... ] }
...
arthropathy) in `lib/hamada-v439.js`, and a two-hundred-sixty-fifth the Barrow classification
(carotid-cavernous fistula) in `lib/barrow-ccf-v440.js`, for 1229 across 345 modules today. <!-- catalog-truth:historical (197 is the count of lib modules adapted, not a catalog tile count) -->

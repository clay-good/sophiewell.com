...
list_calculators { "specialty": "hepatology" }
  -> { coverage: "1208 of 1109 catalog tiles exposed ...", calculators: [ { id: "meld-xi", ... }, ... ] }
...
(subglottic stenosis) in `lib/cotton-myer-v419.js`, for 1208 across 324 modules today. <!-- catalog-truth:historical (197 is the count of lib modules adapted, not a catalog tile count) -->

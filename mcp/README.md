...
list_calculators { "specialty": "hepatology" }
  -> { coverage: "1204 of 1109 catalog tiles exposed ...", calculators: [ { id: "meld-xi", ... }, ... ] }
...
injury) in `lib/geissler-carpal-v415.js`, for 1204 across 320 modules today. <!-- catalog-truth:historical (197 is the count of lib modules adapted, not a catalog tile count) -->

...
const ALLOWED_SPECIALTIES = new Set([
  ...
  'maternal-fetal-medicine', 'neonatology', 'nephrology', 'neurology',
  ...
  'nursing-peds', 'nursing-picu', 'nursing-postop', 'nursing-postpartum',
  ...
  'palliative-care', 'paramedicine', 'pathology', 'pediatric-critical-care',
  'pediatric-emergency-medicine', 'pediatric-nephrology', 'pediatric-surgery',
  'pediatrics', 'perfusion', 'pharmacy', 'physical-medicine-rehabilitation',
  'physical-therapy', 'poison-control', 'psychiatry', 'pulmonology',
  'quality-safety', 'respiratory-therapy', 'social-work',
  'speech-language-pathology', 'sports-medicine', 'surgery', 'surgery-general',
  'toxicology', 'transfusion-medicine', 'trauma-surgery', 'urgent-care',

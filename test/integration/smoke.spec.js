...
test('calculator views do not offer or use persistent input storage', async ({ page }) => {
  await page.goto('/#bmi');
  await expect(page.getByText('Remember my inputs on this device')).toHaveCount(0);

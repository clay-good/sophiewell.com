...
export const renderers = {
  'isis-shoulder'(root) {
    note(root, 'Instability Severity Index Score (ISIS) — recurrence risk after arthroscopic Bankart repair for anterior shoulder instability. Check the preoperative factors; this tool sums them (0–10) and flags a score above 6 (high recurrence risk; an open procedure is favored).');

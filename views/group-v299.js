...
export const renderers = {
  'cosyntropin-stim'(root) {
    note(root, 'Cosyntropin (ACTH) stimulation test interpretation. Enter the peak stimulated serum cortisol (30 or 60 min after 250 µg cosyntropin); this tool compares it with the standard-immunoassay threshold of 18 µg/dL (500 nmol/L). Newer, more specific assays use lower cutoffs — use your laboratory’s.');

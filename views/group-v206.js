...
export const renderers = {
  ...
  // ----- 2.1 rotterdam-ct ----------------------------------------------------
  'rotterdam-ct'(root) {
    note(root, 'Rotterdam CT score (Maas 2005): an additive head-CT prognostic scale — basal cisterns, midline shift, epidural mass (inverted), and intraventricular / traumatic SAH, plus 1 by convention; total 1–6. 6-month mortality rises from ≈ 5% at 1 to ≈ 61% at 6.');
  ...
  // ----- 2.2 marshall-ct -----------------------------------------------------
  'marshall-ct'(root) {
    note(root, 'Marshall CT classification (Marshall 1991): an ordinal head-CT descriptor from basal cisterns, midline shift, and the presence/evacuation of a > 25 cc mass lesion — Diffuse Injury I–IV, plus Evacuated (V) and Non-evacuated (VI) Mass Lesion. Mortality rises across the categories.');

...
export const renderers = {
  'pa-lint'(root) {
    root.appendChild(el('p', { class: 'notice', text:
      'Wave 52-20: drop PDF, DOCX, or TXT files. Sophie hashes each file, '
      ...
      + 'genetic testing), and the complete §4.5.7–§4.5.20 commercial '
      + 'overlays (Aetna + UnitedHealthcare + Anthem + Cigna + Humana + HCSC + '
      + 'Highmark + Florida Blue + BCBSM + Blue Shield of California + Independence Blue Cross + CareFirst + Blue Cross NC + Horizon, 20 rules each) against the aggregated bundle. Overlay rules '

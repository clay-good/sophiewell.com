...
export const renderers = {
  'pa-lint'(root) {
    root.appendChild(el('p', { class: 'notice', text:
      'Wave 52-7c: drop PDF, DOCX, or TXT files. Sophie hashes each file, '
      ...
      + 'genetic testing), and the first §4.5.7 commercial overlay '
      + '(Aetna, 15 rules) against the aggregated bundle. Overlay rules '

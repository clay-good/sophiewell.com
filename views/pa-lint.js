...
export const renderers = {
  'pa-lint'(root) {
    root.appendChild(el('p', { class: 'notice', text:
      'Wave 52-36: drop PDF, DOCX, or TXT files. Sophie hashes each file, '
      ...
      + 'Highmark + Florida Blue + BCBSM + Blue Shield of California + Independence Blue Cross + CareFirst + Blue Cross NC + Horizon + BCBS Tennessee + BCBS Massachusetts + BCBS Alabama + BCBS South Carolina + Arkansas BCBS + BCBS Kansas City + BCBS Minnesota + BCBS Louisiana + HMSA, 20 rules each), and the §4.5.30–§4.5.36 per-state Medicaid overlays (Medi-Cal + New York + Texas + Florida + Ohio + Illinois + Washington Medicaid, 20 rules each) against the aggregated bundle. Overlay rules '

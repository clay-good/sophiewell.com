...
export const renderers = {
  'pa-lint'(root) {
    root.appendChild(el('p', { class: 'notice', text:
      'Wave 52-3c: drop PDF, DOCX, or TXT files. Sophie hashes each file, '
      ...
      + 'overlay (25 rules), and the complete §4.5.3 CMS Medicare '
      + 'Advantage overlay (15 rules) against the aggregated bundle. Overlay rules '

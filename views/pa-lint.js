...
export const renderers = {
  'pa-lint'(root) {
    root.appendChild(el('p', { class: 'notice', text:
      'Wave 52-4a: drop PDF, DOCX, or TXT files. Sophie hashes each file, '
      ...
      + 'overlay (15 rules), plus the first 5 of the §4.5.4 Medicaid '
      + 'state-agnostic core against the aggregated bundle. Overlay rules '

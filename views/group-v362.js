...
export const renderers = {
  'forrester-hemodynamic'(root) {
    note(root, 'Forrester hemodynamic classification (Forrester, Diamond & Swan 1977) of acute MI / acute heart failure. Enter the cardiac index and PCWP. Cold = CI below 2.2 L/min/m2 (hypoperfusion); wet = PCWP above 18 mmHg (congestion). I warm/dry; II warm/wet; III cold/dry; IV cold/wet (cardiogenic shock). The invasive counterpart to the clinical Killip classification.');

// spec-v1486: renderer for pai-periapical (Clinical Scoring & Risk, Group G).
...
export const renderers = {
  'pai-periapical'(root) {
    ...
    wire(ids, () => safe(o, () => {
      ...
      const r = PA.paiPeriapical(args);
      if (!r.valid) { note(o, r.message); return; }
      resultRow(o, [{ text: r.band, cls: r.abnormal ? 'warn' : null }, { label: 'PAI', value: r.bandLabel }]);
      list(o, r.notes);
      note(o, r.note);
    }));
  },

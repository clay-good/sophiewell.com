...
export const renderers = {
  'cholecystitis-severity'(root) {
    note(root, 'Acute cholecystitis severity (Tokyo Guidelines TG18/TG13). Check the criteria you have determined. Grade III (severe): any one organ dysfunction. Grade II (moderate): any one of the moderate criteria. Grade I (mild): neither.');
